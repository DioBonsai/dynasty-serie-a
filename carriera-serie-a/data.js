...
/* ============================================================
  ...
  const SERIE_A_ROSTERS = {
    ...
    'Inter': [{n:'Martinez L.',pos:'ATT',q:34,nat:'ARG',age:29},{n:'Dimarco',pos:'DIF',q:30,nat:'ITA',age:28},{n:'Thuram',pos:'ATT',q:30,nat:'FRA',age:29},{n:'Calhanoglu',pos:'CEN',q:27,nat:'TUR',age:32},{n:'Barella',pos:'CEN',q:18,nat:'ITA',age:29},{n:'Esposito F.P.',pos:'ATT',q:18,nat:'ITA'},{n:'Martinez Jo.',pos:'POR',q:16,nat:'ESP'},{n:'Akanji',pos:'DIF',q:15,nat:'SUI',age:31},{n:'Bastoni',pos:'DIF',q:14,nat:'ITA',age:27},{n:'Zielinski',pos:'CEN',q:13,nat:'POL',age:32},{n:'Bisseck',pos:'DIF',q:12,nat:'GER'},{n:'Stones',pos:'DIF',q:12,nat:'ENG'},{n:'Jones C.',pos:'CEN',q:12,nat:'ENG'},{n:'Spence',pos:'DIF',q:11,nat:'ENG'},{n:'Diouf',pos:'CEN',q:10,nat:'FRA'},{n:'Carlos Augusto',pos:'DIF',q:9,nat:'BRA'},{n:'Sucic P.',pos:'CEN',q:8,nat:'CRO'},{n:'Bonny',pos:'ATT',q:8,nat:'CIV'},{n:'Pavard',pos:'DIF',q:6,nat:'FRA'},{n:'Luis Henrique',pos:'CEN',q:4,nat:'BRA'},{n:'Mkhitaryan',pos:'CEN',q:4,nat:'ARM',age:37},{n:'Stankovic A.',pos:'CEN',q:2,nat:'SRB'},{n:'Di Gennaro',pos:'POR',q:1,nat:'ITA'},{n:'Provedel',pos:'POR',q:1,nat:'ITA'}],
    'Juventus': [{n:'Kolo Muani',pos:'ATT',q:24,nat:'FRA',age:27},{n:'Woltemade',pos:'ATT',q:22,nat:'GER',age:24},{n:'Yildiz',pos:'ATT',q:21,nat:'TUR',age:21},{n:'Vicario',pos:'POR',q:16,nat:'ITA',age:29},{n:'Bremer',pos:'DIF',q:16,nat:'BRA',age:29},{n:'McKennie',pos:'CEN',q:16,nat:'USA',age:28},{n:'Kalulu',pos:'DIF',q:13,nat:'FRA'},{n:'Conceicao',pos:'CEN',q:13,nat:'POR'},{n:'Gonzalez N.',pos:'CEN',q:13,nat:'ARG'},{n:'Alajbegovic',pos:'CEN',q:11,nat:'BIH'},{n:'Thuram K.',pos:'CEN',q:9,nat:'FRA'},{n:'Lucumì',pos:'DIF',q:8,nat:'COL'},{n:'Cambiaso',pos:'DIF',q:8,nat:'ITA'},{n:'Locatelli',pos:'CEN',q:8,nat:'ITA',age:28},{n:'Zhegrova',pos:'CEN',q:8,nat:'KVX'},{n:'Celik',pos:'DIF',q:7,nat:'TUR'},{n:'Koopmeiners',pos:'CEN',q:7,nat:'NED',age:28},{n:'Sarr P.',pos:'CEN',q:7,nat:'SEN'},{n:'Boga',pos:'ATT',q:6,nat:'CIV'},{n:'Gatti',pos:'DIF',q:5,nat:'ITA'},{n:'Kelly L.',pos:'DIF',q:5,nat:'ENG'},{n:'Douglas Luiz',pos:'CEN',q:4,nat:'BRA'},{n:'Milik',pos:'ATT',q:4,nat:'POL',age:32},{n:'Ekhator',pos:'ATT',q:2,nat:'ITA'},{n:'Pinsoglio',pos:'POR',q:1,nat:'ITA'},{n:'Grabara',pos:'POR',q:1,nat:'POL'},{n:'Rugani',pos:'DIF',q:1,nat:'ITA'},{n:'Cabal',pos:'DIF',q:1,nat:'COL'}],
    'Milan': [{n:'Ramos G.',pos:'ATT',q:26,nat:'POR'},{n:'Pulisic',pos:'CEN',q:24,nat:'USA',age:28},{n:'Rabiot',pos:'CEN',q:23,nat:'FRA',age:31},{n:'Maignan',pos:'POR',q:14,nat:'FRA',age:31},{n:'Pavlovic',pos:'DIF',q:13,nat:'SRB'},{n:'Moreira',pos:'CEN',q:13,nat:'BEL'},{n:'Gila',pos:'DIF',q:12,nat:'ESP'},{n:'Modric',pos:'CEN',q:12,nat:'CRO',age:41},{n:'Saelemaekers',pos:'CEN',q:10,nat:'BEL'},{n:'Bartesaghi',pos:'DIF',q:8,nat:'ITA'},{n:'Chukwueze',pos:'CEN',q:8,nat:'NGA'},{n:'Hutchinson',pos:'CEN',q:7,nat:'ENG'},{n:'Gabbia',pos:'DIF',q:6,nat:'ITA'},{n:'Tomori',pos:'DIF',q:6,nat:'ENG',age:28},{n:'Cissè A.',pos:'CEN',q:6,nat:'ITA'},{n:'De Winter',pos:'DIF',q:5,nat:'BEL'},{n:'Jashari',pos:'CEN',q:5,nat:'SUI'},{n:'Musah',pos:'CEN',q:5,nat:'USA'},{n:'Loftus-Cheek',pos:'CEN',q:4,nat:'ENG',age:30},{n:'Camarda',pos:'ATT',q:4,nat:'ITA'},{n:'Estupinan',pos:'DIF',q:3,nat:'ECU'},{n:'Terracciano',pos:'POR',q:1,nat:'ITA'},{n:'Torriani',pos:'POR',q:1,nat:'ITA'},{n:'Diawara S.',pos:'DIF',q:1,nat:'FRA'},{n:'Terracciano F.',pos:'DIF',q:1,nat:'ITA'},{n:'Comotto',pos:'CEN',q:1,nat:'ITA'}],
    'Atalanta': [{n:'Scamacca',pos:'ATT',q:20,nat:'ITA',age:27},{n:'Krstovic',pos:'ATT',q:17,nat:'MNE'},{n:'Carnesecchi',pos:'POR',q:16,nat:'ITA',age:25},{n:'De Ketelaere',pos:'ATT',q:16,nat:'BEL',age:25},{n:'Samardzic',pos:'CEN',q:13,nat:'SRB'},{n:'Raspadori',pos:'ATT',q:13,nat:'ITA'},{n:'Ederson D.S.',pos:'CEN',q:12,nat:'BRA'},{n:'Kessiè',pos:'CEN',q:11,nat:'CIV',age:29},{n:'Scalvini',pos:'DIF',q:10,nat:'ITA'},{n:'Rowe',pos:'CEN',q:10,nat:'ENG'},{n:'Zappacosta',pos:'DIF',q:8,nat:'ITA',age:34},{n:'Pasalic',pos:'CEN',q:8,nat:'CRO',age:31},{n:'Hien',pos:'DIF',q:7,nat:'SWE'},{n:'Gaetano',pos:'CEN',q:7,nat:'ITA'},{n:'Zalewski',pos:'CEN',q:7,nat:'POL'},{n:'Kolasinac',pos:'DIF',q:6,nat:'BIH'},{n:'Bernasconi',pos:'DIF',q:6,nat:'ITA'},{n:'Kristensen T.',pos:'DIF',q:6,nat:'DEN'},{n:'Elmas',pos:'CEN',q:6,nat:'MKD'},{n:'Bellanova',pos:'DIF',q:5,nat:'ITA'},{n:'Sulemana K.',pos:'ATT',q:5,nat:'GHA'},{n:'Kossounou',pos:'DIF',q:3,nat:'CIV'},{n:'Sportiello',pos:'POR',q:1,nat:'ITA'},{n:'Pompei',pos:'POR',q:1,nat:'ITA'}],
    'Roma': [{n:'Malen',pos:'ATT',q:37,nat:'NED'},{n:'Mora',pos:'CEN',q:20,nat:'POR'},{n:'Svilar',pos:'POR',q:19,nat:'SRB',age:26},{n:'Wesley',pos:'DIF',q:18,nat:'BRA'},{n:'Molina N.',pos:'DIF',q:18,nat:'ARG'},{n:'Dybala',pos:'ATT',q:16,nat:'ARG',age:33},{n:'Mancini',pos:'DIF',q:15,nat:'ITA',age:28},{n:'Soulè',pos:'ATT',q:15,nat:'ARG'},{n:'Castro S.',pos:'ATT',q:14,nat:'ARG'},{n:'N\'Dicka',pos:'DIF',q:12,nat:'CIV'},{n:'Hermoso',pos:'DIF',q:11,nat:'ESP',age:31},{n:'Konè M.',pos:'CEN',q:10,nat:'FRA'},{n:'Cristante',pos:'CEN',q:9,nat:'ITA',age:31},{n:'Pellegrini Lo.',pos:'CEN',q:9,nat:'ITA',age:30},{n:'Pisilli',pos:'CEN',q:8,nat:'ITA'},{n:'Koulierakis',pos:'DIF',q:7,nat:'GRE'},{n:'Balerdi',pos:'DIF',q:7,nat:'ARG'},{n:'Ghilardi',pos:'DIF',q:5,nat:'ITA'},{n:'Rensch',pos:'DIF',q:4,nat:'NED'},{n:'De Roon',pos:'CEN',q:4,nat:'NED',age:36},{n:'Lulli',pos:'DIF',q:3,nat:'ITA'},{n:'De Marzi',pos:'POR',q:1,nat:'USA'},{n:'Gollini',pos:'POR',q:1,nat:'ITA'}],
    'Fiorentina': [{n:'Atta',pos:'CEN',q:16,nat:'FRA'},{n:'Pellegrino M.',pos:'ATT',q:16,nat:'ARG'},{n:'Mastantuono',pos:'CEN',q:14,nat:'ARG'},{n:'Beto',pos:'ATT',q:14,nat:'GNB'},{n:'Goncalves P.',pos:'CEN',q:11,nat:'POR'},{n:'De Gea',pos:'POR',q:10,nat:'ESP',age:35},{n:'Dodò',pos:'DIF',q:9,nat:'BRA'},{n:'Dragusin',pos:'DIF',q:8,nat:'ROU'},{n:'Jimenez A.',pos:'DIF',q:8,nat:'ESP'},{n:'Fagioli',pos:'CEN',q:8,nat:'ITA',age:25},{n:'Ndour',pos:'CEN',q:8,nat:'ITA'},{n:'Gnonto',pos:'ATT',q:7,nat:'ITA',age:22},{n:'Viery',pos:'DIF',q:6,nat:'BRA'},{n:'Oulai',pos:'CEN',q:6,nat:'CIV'},{n:'Valdepenas',pos:'DIF',q:5,nat:'ESP'},{n:'Njie',pos:'CEN',q:5,nat:'SWE'},{n:'Parisi',pos:'DIF',q:4,nat:'ITA'},{n:'Pongracic',pos:'DIF',q:3,nat:'CRO'},{n:'Ranieri L.',pos:'DIF',q:3,nat:'ITA',age:29},{n:'Brescianini',pos:'CEN',q:3,nat:'ITA'},{n:'Joao Mario',pos:'DIF',q:2,nat:'POR'},{n:'Christensen O.',pos:'POR',q:1,nat:'DEN'},{n:'Lezzerini',pos:'POR',q:1,nat:'ITA'}],
    'Bologna': [{n:'Orsolini',pos:'CEN',q:24,nat:'ITA',age:29},{n:'Dovbyk',pos:'ATT',q:16,nat:'UKR',age:29},{n:'Skorupski',pos:'POR',q:10,nat:'POL',age:35},{n:'Bernardeschi',pos:'CEN',q:10,nat:'ITA',age:32},{n:'Piccoli',pos:'ATT',q:9,nat:'ITA'},{n:'Miranda J.',pos:'DIF',q:8,nat:'ESP'},{n:'Theate',pos:'DIF',q:8,nat:'BEL'},{n:'Ferguson',pos:'CEN',q:8,nat:'SCO',age:26},{n:'Cambiaghi',pos:'CEN',q:8,nat:'ITA'},{n:'Pobega',pos:'CEN',q:7,nat:'ITA'},{n:'Odgaard',pos:'CEN',q:7,nat:'DEN'},{n:'Mbangula',pos:'CEN',q:7,nat:'BEL'},{n:'Heggem',pos:'DIF',q:6,nat:'NOR'},{n:'Holm',pos:'DIF',q:6,nat:'SWE'},{n:'Zortea',pos:'DIF',q:6,nat:'ITA'},{n:'Vitik',pos:'DIF',q:4,nat:'CZE'},{n:'Amondarain',pos:'CEN',q:4,nat:'ARG'},{n:'Moro N.',pos:'CEN',q:4,nat:'CRO'},{n:'Helland',pos:'DIF',q:3,nat:'NOR'},{n:'Pessina Mas.',pos:'POR',q:2,nat:'ITA'},{n:'Casale',pos:'DIF',q:2,nat:'ITA'},{n:'Alhassane',pos:'DIF',q:2,nat:'NIG'},{n:'El Azzouzi O.',pos:'CEN',q:2,nat:'MAR'},{n:'Enem',pos:'ATT',q:2,nat:'NED'},{n:'Happonen',pos:'POR',q:1,nat:'FIN'},{n:'De Silvestri',pos:'DIF',q:1,nat:'ITA'},{n:'Libra',pos:'CEN',q:1,nat:'VEN'}],
    'Lazio': [{n:'Zaccagni',pos:'CEN',q:16,nat:'ITA',age:31},{n:'Gudmundsson A.',pos:'CEN',q:13,nat:'ISL'},{n:'Taylor K.',pos:'CEN',q:13,nat:'NED'},{n:'Mandas',pos:'POR',q:11,nat:'GRE'},{n:'Frattesi',pos:'CEN',q:11,nat:'ITA'},{n:'Pinamonti',pos:'ATT',q:11,nat:'ITA'},{n:'Cancellieri',pos:'CEN',q:10,nat:'ITA'},{n:'Isaksen',pos:'CEN',q:9,nat:'DEN'},{n:'Doekhi',pos:'DIF',q:8,nat:'NED'},{n:'Noslin',pos:'ATT',q:8,nat:'NED'},{n:'Tavares N.',pos:'DIF',q:7,nat:'POR'},{n:'Marusic',pos:'DIF',q:6,nat:'MNE'},{n:'Sutalo J.',pos:'DIF',q:6,nat:'CRO'},{n:'Leite',pos:'DIF',q:6,nat:'POR'},{n:'Rovella',pos:'CEN',q:6,nat:'ITA',age:24},{n:'Pedraza',pos:'DIF',q:5,nat:'ESP'},{n:'Provstgaard',pos:'DIF',q:4,nat:'DEN'},{n:'Floriani Mussolini',pos:'DIF',q:4,nat:'ITA'},{n:'Dele-Bashiru',pos:'CEN',q:4,nat:'NGA'},{n:'Belahyane',pos:'CEN',q:3,nat:'MAR'},{n:'Cataldi',pos:'CEN',q:3,nat:'ITA',age:29},{n:'Motta',pos:'POR',q:1,nat:'ITA'},{n:'Renzetti',pos:'POR',q:1,nat:'ITA'},{n:'Patric',pos:'DIF',q:1,nat:'ESP'},{n:'Lazzari',pos:'DIF',q:1,nat:'ITA'},{n:'Pellegrini Lu.',pos:'DIF',q:1,nat:'ITA'},{n:'Przyborek',pos:'CEN',q:1,nat:'POL'}],
    ...
    'Genoa': [{n:'Baldanzi',pos:'CEN',q:11,nat:'ITA'},{n:'Ostigard',pos:'DIF',q:10,nat:'NOR'},{n:'Colombo',pos:'ATT',q:10,nat:'ITA'},{n:'Vasquez',pos:'DIF',q:9,nat:'MEX'},{n:'Osmajic',pos:'ATT',q:9,nat:'MNE'},{n:'Vitinha O.',pos:'ATT',q:8,nat:'POR'},{n:'Bijlow',pos:'POR',q:7,nat:'NED'},{n:'Frendrup',pos:'CEN',q:7,nat:'DEN',age:26},{n:'Sow',pos:'CEN',q:7,nat:'SUI'},{n:'El Shaarawy',pos:'CEN',q:7,nat:'ITA',age:33},{n:'Marcandalli',pos:'DIF',q:6,nat:'ITA'},{n:'Ellertsson',pos:'CEN',q:6,nat:'ISL'},{n:'Messias',pos:'CEN',q:5,nat:'BRA'},{n:'Ehizibue',pos:'DIF',q:4,nat:'NED'},{n:'Amorim',pos:'CEN',q:4,nat:'BRA'},{n:'Meichtry',pos:'CEN',q:4,nat:'SUI'},{n:'Traorè Hj.',pos:'CEN',q:4,nat:'CIV'},{n:'Mitaj',pos:'DIF',q:3,nat:'ALB'},{n:'Drameh',pos:'DIF',q:3,nat:'ENG'},{n:'Havel',pos:'ATT',q:3,nat:'AUT'},{n:'Otoa',pos:'DIF',q:2,nat:'DEN'},{n:'Sabelli',pos:'DIF',q:2,nat:'ITA'},{n:'Sommariva',pos:'POR',q:1,nat:'ITA'},{n:'Stolz',pos:'POR',q:1,nat:'AUT'},{n:'Puczka',pos:'DIF',q:1,nat:'AUT'},{n:'Venturino',pos:'CEN',q:1,nat:'ITA'},{n:'Robinho Junior',pos:'ATT',q:1,nat:'BRA'}],
    'Sassuolo': [{n:'Berardi',pos:'ATT',q:18,nat:'ITA',age:32},{n:'Laurientè',pos:'ATT',q:16,nat:'FRA',age:28},{n:'Esposito Se.',pos:'ATT',q:13,nat:'ITA'},{n:'Bowie',pos:'ATT',q:11,nat:'SCO'},{n:'Thorstvedt',pos:'CEN',q:10,nat:'NOR'},{n:'Adzic',pos:'CEN',q:9,nat:'MNE'},{n:'Volpato',pos:'CEN',q:9,nat:'AUS'},{n:'Konè I.',pos:'CEN',q:8,nat:'CAN'},{n:'Idzes',pos:'DIF',q:7,nat:'IDN'},{n:'Doig',pos:'DIF',q:7,nat:'SCO'},{n:'Leysen F.',pos:'DIF',q:7,nat:'BEL'},{n:'Matic',pos:'CEN',q:7,nat:'SRB'},{n:'Muric',pos:'POR',q:6,nat:'KVX'},{n:'Obrador',pos:'DIF',q:6,nat:'ESP'},{n:'Caleta-Car',pos:'DIF',q:6,nat:'CRO'},{n:'Bakola',pos:'CEN',q:6,nat:'FRA'},{n:'Cinquegrano',pos:'DIF',q:4,nat:'ITA'},{n:'Dominguez B.',pos:'CEN',q:4,nat:'ARG'},{n:'Walukiewicz',pos:'DIF',q:3,nat:'POL'},{n:'Odenthal',pos:'DIF',q:3,nat:'NED'},{n:'Sulemana I.',pos:'CEN',q:3,nat:'GHA'},{n:'Lipani',pos:'CEN',q:3,nat:'ITA'},{n:'Candè',pos:'DIF',q:2,nat:'GNB'},{n:'Russo A.',pos:'POR',q:1,nat:'ITA'},{n:'Turati',pos:'POR',q:1,nat:'ITA'},{n:'Satalino',pos:'POR',q:1,nat:'ITA'},{n:'Van Der Brempt',pos:'DIF',q:1,nat:'BEL'},{n:'Pieragnolo',pos:'DIF',q:1,nat:'ITA'},{n:'Boloca',pos:'CEN',q:1,nat:'ITA',age:27}],
    ...
    'Cagliari': [{n:'Caprile',pos:'POR',q:11,nat:'ITA'},{n:'Kevin Carlos',pos:'ATT',q:11,nat:'ESP'},{n:'Maldini',pos:'ATT',q:9,nat:'ITA'},{n:'Obert',pos:'DIF',q:8,nat:'SVK'},{n:'Adopo',pos:'CEN',q:8,nat:'FRA'},{n:'Romano',pos:'CEN',q:8,nat:'ITA'},{n:'Mina',pos:'DIF',q:7,nat:'COL',age:31},{n:'Zè Pedro',pos:'DIF',q:7,nat:'POR'},{n:'Winks',pos:'CEN',q:7,nat:'ENG'},{n:'Fazzini',pos:'CEN',q:7,nat:'ITA'},{n:'Mendy P.',pos:'ATT',q:7,nat:'SEN'},{n:'Sugawara',pos:'DIF',q:6,nat:'JPN'},{n:'Kofler',pos:'DIF',q:5,nat:'ITA'},{n:'Rodriguez Ju.',pos:'DIF',q:5,nat:'URU'},{n:'Deiola',pos:'CEN',q:5,nat:'ITA'},{n:'Felici',pos:'CEN',q:5,nat:'ITA'},{n:'Fadera',pos:'CEN',q:4,nat:'GAM'},{n:'Massolin',pos:'CEN',q:4,nat:'FRA'},{n:'Nzola',pos:'ATT',q:4,nat:'ANG'},{n:'Gagliardini',pos:'CEN',q:3,nat:'ITA'},{n:'Idrissi R.',pos:'DIF',q:2,nat:'ITA'},{n:'Sherri',pos:'POR',q:1,nat:'ALB'},{n:'Radunovic',pos:'POR',q:1,nat:'SRB'},{n:'Aurelio',pos:'DIF',q:1,nat:'ITA'},{n:'Liteta',pos:'CEN',q:1,nat:'ZAM'},{n:'Ciervo',pos:'CEN',q:1,nat:'ITA'},{n:'Trepy',pos:'ATT',q:1,nat:'FRA'}],
    ...
    'Como': [{n:'Paz N.',pos:'CEN',q:30,nat:'ARG',age:22},{n:'Kean',pos:'ATT',q:24,nat:'ITA',age:26},{n:'Douvikas',pos:'ATT',q:21,nat:'GRE',age:27},{n:'Baturina',pos:'CEN',q:20,nat:'CRO',age:24},{n:'Da Cunha',pos:'CEN',q:18,nat:'FRA'},{n:'Butez',pos:'POR',q:15,nat:'FRA',age:30},{n:'Diao',pos:'ATT',q:14,nat:'SEN'},{n:'Ramon',pos:'DIF',q:12,nat:'ESP'},{n:'Perrone',pos:'CEN',q:11,nat:'ARG'},{n:'Rodriguez Je.',pos:'CEN',q:11,nat:'ESP'},{n:'Chalobah T.',pos:'DIF',q:10,nat:'ENG'},{n:'Couto',pos:'DIF',q:9,nat:'BRA'},{n:'Sanchez Ro.',pos:'POR',q:8,nat:'ESP'},{n:'Kaiki',pos:'DIF',q:8,nat:'BRA'},{n:'Valle',pos:'DIF',q:7,nat:'ESP'},{n:'Kempf',pos:'DIF',q:6,nat:'GER'},{n:'Milla',pos:'CEN',q:6,nat:'ESP'},{n:'Caqueret',pos:'CEN',q:6,nat:'FRA',age:26},{n:'Liberali',pos:'CEN',q:6,nat:'ITA'},{n:'Addai',pos:'CEN',q:4,nat:'NED'},{n:'Smolcic I.',pos:'DIF',q:3,nat:'CRO'},{n:'Ricci S.',pos:'CEN',q:3,nat:'ITA',age:24},{n:'Kambwala',pos:'DIF',q:2,nat:'FRA'},{n:'Vigorito',pos:'POR',q:1,nat:'ITA'},{n:'Goldaniga',pos:'DIF',q:1,nat:'ITA'},{n:'Lahdo',pos:'CEN',q:1,nat:'SWE'}],
  };
 ...
 ,
  ...
  const EURO_ROSTERS = {
    'Real Madrid': [{n:'Courtois',pos:'POR',ovr:89,nat:'BEL',age:34},{n:'Huijsen',pos:'DIF',ovr:85,nat:'ESP'},{n:'Militao',pos:'DIF',ovr:84,nat:'BRA',age:25},{n:'Trent',pos:'DIF',ovr:86,nat:'ENG',age:27},{n:'Rudiger',pos:'DIF',ovr:85,nat:'GER',age:33},{n:'Valverde',pos:'CEN',ovr:87,nat:'URU',age:27},{n:'Bellingham',pos:'CEN',ovr:89,nat:'ENG',age:23},{n:'Tchouameni',pos:'CEN',ovr:85,nat:'FRA',age:26},{n:'Camavinga',pos:'CEN',ovr:84,nat:'FRA',age:23},{n:'Mbappe',pos:'ATT',ovr:93,nat:'FRA',age:27},{n:'Vinicius Jr',pos:'ATT',ovr:91,nat:'BRA',age:26},{n:'Rodrygo',pos:'ATT',ovr:85,nat:'BRA',age:25}],
    'Manchester City': [{n:'Donnarumma',pos:'POR',ovr:89,nat:'ITA',age:27},{n:'Dias',pos:'DIF',ovr:86,nat:'POR',age:29},{n:'Gvardiol',pos:'DIF',ovr:85,nat:'CRO',age:24},{n:'Ait-Nouri',pos:'DIF',ovr:81,nat:'ALG'},{n:'Rico Lewis',pos:'DIF',ovr:80,nat:'ENG'},{n:'Foden',pos:'CEN',ovr:88,nat:'ENG',age:26},{n:'Enzo Fernandez',pos:'CEN',ovr:86,nat:'ARG'},{n:'Kovacic',pos:'CEN',ovr:82,nat:'CRO',age:32},{n:'Cherki',pos:'CEN',ovr:83,nat:'FRA'},{n:'Haaland',pos:'ATT',ovr:94,nat:'NOR',age:26},{n:'Doku',pos:'ATT',ovr:85,nat:'BEL',age:24},{n:'Ndiaye',pos:'ATT',ovr:80,nat:'SEN'}],
    'Bayern Monaco': [{n:'Neuer',pos:'POR',ovr:84,nat:'GER',age:40},{n:'Upamecano',pos:'DIF',ovr:85,nat:'FRA',age:27},{n:'Kim Min-jae',pos:'DIF',ovr:84,nat:'KOR',age:30},{n:'Tah',pos:'DIF',ovr:84,nat:'GER'},{n:'Davies',pos:'DIF',ovr:85,nat:'CAN',age:26},{n:'Kimmich',pos:'CEN',ovr:88,nat:'GER',age:31},{n:'Musiala',pos:'CEN',ovr:89,nat:'GER',age:23},{n:'Olise',pos:'CEN',ovr:87,nat:'FRA',age:24},{n:'Pavlovic',pos:'CEN',ovr:81,nat:'SRB'},{n:'Kane',pos:'ATT',ovr:90,nat:'ENG',age:33},{n:'Diaz',pos:'ATT',ovr:85,nat:'COL',age:30},{n:'Gnabry',pos:'ATT',ovr:80,nat:'GER'}],
    'Paris Saint-Germain': [{n:'Chevalier',pos:'POR',ovr:84,nat:'FRA'},{n:'Hakimi',pos:'DIF',ovr:88,nat:'MAR',age:27},{n:'Marquinhos',pos:'DIF',ovr:85,nat:'BRA',age:32},{n:'Nuno Mendes',pos:'DIF',ovr:85,nat:'POR',age:24},{n:'Zabarnyi',pos:'DIF',ovr:80,nat:'UKR'},{n:'Vitinha',pos:'CEN',ovr:87,nat:'POR',age:26},{n:'Joao Neves',pos:'CEN',ovr:86,nat:'POR',age:21},{n:'Zaire-Emery',pos:'CEN',ovr:84,nat:'FRA'},{n:'Fabian Ruiz',pos:'CEN',ovr:84,nat:'ESP',age:30},{n:'Dembele',pos:'ATT',ovr:91,nat:'FRA',age:29},{n:'Doue',pos:'ATT',ovr:87,nat:'FRA',age:20},{n:'Kvaratskhelia',pos:'ATT',ovr:87,nat:'GEO',age:25}],
    'Liverpool': [{n:'Alisson',pos:'POR',ovr:87,nat:'BRA',age:34},{n:'Van Dijk',pos:'DIF',ovr:87,nat:'NED',age:35},{n:'Araujo',pos:'DIF',ovr:82,nat:'URU'},{n:'Frimpong',pos:'DIF',ovr:81,nat:'NED'},{n:'Gomez',pos:'DIF',ovr:79,nat:'ENG'},{n:'Wirtz',pos:'CEN',ovr:88,nat:'GER',age:23},{n:'Mac Allister',pos:'CEN',ovr:86,nat:'ARG',age:27},{n:'Szoboszlai',pos:'CEN',ovr:85,nat:'HUN',age:26},{n:'Gravenberch',pos:'CEN',ovr:84,nat:'NED'},{n:'Isak',pos:'ATT',ovr:88,nat:'SWE',age:27},{n:'Gakpo',pos:'ATT',ovr:83,nat:'NED',age:27},{n:'Ekitike',pos:'ATT',ovr:82,nat:'FRA'}],
    'Barcellona': [{n:'Joan Garcia',pos:'POR',ovr:83,nat:'ESP'},{n:'Kounde',pos:'DIF',ovr:85,nat:'FRA',age:27},{n:'Cubarsi',pos:'DIF',ovr:83,nat:'ESP'},{n:'Balde',pos:'DIF',ovr:83,nat:'ESP'},{n:'Christensen',pos:'DIF',ovr:80,nat:'DEN'},{n:'Pedri',pos:'CEN',ovr:88,nat:'ESP',age:24},{n:'De Jong',pos:'CEN',ovr:86,nat:'NED',age:29},{n:'Gavi',pos:'CEN',ovr:85,nat:'ESP',age:22},{n:'Olmo',pos:'CEN',ovr:85,nat:'ESP',age:28},{n:'Yamal',pos:'ATT',ovr:91,nat:'ESP',age:19},{n:'Raphinha',pos:'ATT',ovr:88,nat:'BRA',age:29},{n:'Fermin Lopez',pos:'ATT',ovr:80,nat:'ESP'}],
    'Arsenal': [{n:'Raya',pos:'POR',ovr:86,nat:'ESP',age:30},{n:'Saliba',pos:'DIF',ovr:88,nat:'FRA',age:25},{n:'Gabriel',pos:'DIF',ovr:86,nat:'BRA',age:28},{n:'Timber',pos:'DIF',ovr:83,nat:'NED'},{n:'Calafiori',pos:'DIF',ovr:83,nat:'ITA'},{n:'Rice',pos:'CEN',ovr:87,nat:'ENG',age:27},{n:'Odegaard',pos:'CEN',ovr:87,nat:'NOR',age:27},{n:'Zubimendi',pos:'CEN',ovr:83,nat:'ESP'},{n:'Eze',pos:'CEN',ovr:84,nat:'ENG'},{n:'Saka',pos:'ATT',ovr:89,nat:'ENG',age:24},{n:'Gyokeres',pos:'ATT',ovr:85,nat:'SWE'},{n:'Havertz',pos:'ATT',ovr:83,nat:'GER',age:27}],
    'Chelsea': [{n:'E. Martinez',pos:'POR',ovr:84,nat:'ARG'},{n:'James',pos:'DIF',ovr:82,nat:'ENG',age:26},{n:'Colwill',pos:'DIF',ovr:83,nat:'ENG'},{n:'Fofana',pos:'DIF',ovr:81,nat:'FRA'},{n:'Gusto',pos:'DIF',ovr:80,nat:'FRA'},{n:'Caicedo',pos:'CEN',ovr:85,nat:'ECU',age:24},{n:'Palmer',pos:'CEN',ovr:87,nat:'ENG',age:24},{n:'Barco',pos:'CEN',ovr:78,nat:'ARG'},{n:'Joao Pedro',pos:'ATT',ovr:83,nat:'BRA',age:24},{n:'Estevao',pos:'ATT',ovr:83,nat:'BRA'},{n:'Neto',pos:'ATT',ovr:81,nat:'POR'},{n:'Gittens',pos:'ATT',ovr:78,nat:'ENG'}],
    'Borussia Dortmund': [{n:'Kobel',pos:'POR',ovr:84,nat:'SUI',age:29},{n:'Schlotterbeck',pos:'DIF',ovr:83,nat:'GER'},{n:'Anton',pos:'DIF',ovr:79,nat:'GER'},{n:'Bensebaini',pos:'DIF',ovr:79,nat:'ALG'},{n:'Ryerson',pos:'DIF',ovr:78,nat:'NOR'},{n:'Jobe Bellingham',pos:'CEN',ovr:81,nat:'ENG'},{n:'Nmecha',pos:'CEN',ovr:78,nat:'GER'},{n:'Sabitzer',pos:'CEN',ovr:79,nat:'AUT'},{n:'Can',pos:'CEN',ovr:77,nat:'GER'},{n:'Guirassy',pos:'ATT',ovr:85,nat:'GUI',age:30},{n:'Beier',pos:'ATT',ovr:79,nat:'GER'},{n:'Fabio Silva',pos:'ATT',ovr:76,nat:'POR'}],
    'Atletico Madrid': [{n:'Oblak',pos:'POR',ovr:86,nat:'SVN',age:33},{n:'Le Normand',pos:'DIF',ovr:83,nat:'ESP'},{n:'Hancko',pos:'DIF',ovr:82,nat:'SVK'},{n:'Grimaldo',pos:'DIF',ovr:83,nat:'ESP'},{n:'Pubill',pos:'DIF',ovr:78,nat:'ESP'},{n:'Koke',pos:'CEN',ovr:80,nat:'ESP',age:34},{n:'Barrios',pos:'CEN',ovr:81,nat:'ESP'},{n:'Baena',pos:'CEN',ovr:83,nat:'ESP'},{n:'Llorente',pos:'CEN',ovr:80,nat:'ESP'},{n:'Julian Alvarez',pos:'ATT',ovr:88,nat:'ARG',age:26},{n:'Lookman',pos:'ATT',ovr:84,nat:'NGA',age:28},{n:'Sorloth',pos:'ATT',ovr:82,nat:'NOR',age:30}],
    'Bayer Leverkusen': [{n:'Flekken',pos:'POR',ovr:80,nat:'NED'},{n:'Tapsoba',pos:'DIF',ovr:81,nat:'BFA'},{n:'Hincapie',pos:'DIF',ovr:82,nat:'ECU'},{n:'Grimaldo',pos:'DIF',ovr:84,nat:'ESP',age:30},{n:'Andrich',pos:'CEN',ovr:78,nat:'GER'},{n:'Aleix Garcia',pos:'CEN',ovr:81,nat:'ESP'},{n:'Palacios',pos:'CEN',ovr:77,nat:'ARG'},{n:'Tillman',pos:'CEN',ovr:79,nat:'USA'},{n:'Schick',pos:'ATT',ovr:82,nat:'CZE',age:30},{n:'Boniface',pos:'ATT',ovr:80,nat:'NGA'},{n:'Poku',pos:'ATT',ovr:76,nat:'NED'}],
    'Manchester United': [{n:'Onana',pos:'POR',ovr:79,nat:'CMR',age:30},{n:'De Ligt',pos:'DIF',ovr:83,nat:'NED'},{n:'Lisandro Martinez',pos:'DIF',ovr:82,nat:'ARG'},{n:'Dalot',pos:'DIF',ovr:78,nat:'POR'},{n:'Shaw',pos:'DIF',ovr:79,nat:'ENG'},{n:'Bruno Fernandes',pos:'CEN',ovr:87,nat:'POR',age:32},{n:'Casemiro',pos:'CEN',ovr:80,nat:'BRA',age:34},{n:'Mainoo',pos:'CEN',ovr:79,nat:'ENG'},{n:'Ugarte',pos:'CEN',ovr:78,nat:'URU'},{n:'Cunha',pos:'ATT',ovr:83,nat:'BRA',age:27},{n:'Mbeumo',pos:'ATT',ovr:82,nat:'CMR'},{n:'Sesko',pos:'ATT',ovr:80,nat:'SVN'}],
    'Tottenham': [{n:'Vicario',pos:'POR',ovr:81,nat:'ITA',age:29},{n:'Romero',pos:'DIF',ovr:84,nat:'ARG',age:28},{n:'Van de Ven',pos:'DIF',ovr:82,nat:'NED',age:25},{n:'Udogie',pos:'DIF',ovr:79,nat:'ITA'},{n:'Porro',pos:'DIF',ovr:80,nat:'ESP'},{n:'Bissouma',pos:'CEN',ovr:80,nat:'MLI'},{n:'Bentancur',pos:'CEN',ovr:79,nat:'URU'},{n:'Maddison',pos:'CEN',ovr:82,nat:'ENG',age:30},{n:'Kudus',pos:'ATT',ovr:81,nat:'GHA',age:25},{n:'Richarlison',pos:'ATT',ovr:79,nat:'BRA'},{n:'Solanke',pos:'ATT',ovr:80,nat:'ENG',age:29},{n:'Johnson',pos:'ATT',ovr:78,nat:'WAL'}],
    'Benfica': [{n:'Trubin',pos:'POR',ovr:82,nat:'UKR',age:24},{n:'Antonio Silva',pos:'DIF',ovr:83,nat:'POR',age:22},{n:'Otamendi',pos:'DIF',ovr:78,nat:'ARG',age:38},{n:'Bah',pos:'DIF',ovr:77,nat:'DEN'},{n:'Kokcu',pos:'CEN',ovr:80,nat:'TUR'},{n:'Florentino',pos:'CEN',ovr:76,nat:'POR'},{n:'Barrenechea',pos:'CEN',ovr:77,nat:'ARG'},{n:'Richard Rios',pos:'CEN',ovr:79,nat:'COL'},{n:'Akturkoglu',pos:'ATT',ovr:78,nat:'TUR'},{n:'Pavlidis',pos:'ATT',ovr:81,nat:'GRE'},{n:'Aursnes',pos:'CEN',ovr:75,nat:'NOR'}],
    'Porto': [{n:'Diogo Costa',pos:'POR',ovr:85,nat:'POR',age:27},{n:'Nehuen Perez',pos:'DIF',ovr:78,nat:'ARG'},{n:'Zaidu',pos:'DIF',ovr:75,nat:'NGA'},{n:'Bednarek',pos:'DIF',ovr:76,nat:'POL'},{n:'Eustaquio',pos:'CEN',ovr:78,nat:'CAN'},{n:'Alan Varela',pos:'CEN',ovr:80,nat:'ARG'},{n:'Gabri Veiga',pos:'CEN',ovr:79,nat:'ESP'},{n:'Rodrigo Mora',pos:'CEN',ovr:78,nat:'POR'},{n:'Pepe',pos:'ATT',ovr:77,nat:'BRA'},{n:'Samu',pos:'ATT',ovr:78,nat:'ESP'},{n:'Luuk de Jong',pos:'ATT',ovr:76,nat:'NED'},{n:'Borja Sainz',pos:'ATT',ovr:77,nat:'ESP'}],
    ...
    'Real Sociedad': [{n:'Remiro',pos:'POR',ovr:80,nat:'ESP',age:31},{n:'Zubeldia',pos:'DIF',ovr:76,nat:'ESP'},{n:'Aramburu',pos:'DIF',ovr:73,nat:'VEN'},{n:'Caleta-Car',pos:'DIF',ovr:75,nat:'CRO'},{n:'Aihen Munoz',pos:'DIF',ovr:73,nat:'ESP'},{n:'Brais Mendez',pos:'CEN',ovr:78,nat:'ESP'},{n:'Zakharyan',pos:'CEN',ovr:77,nat:'RUS'},{n:'Sucic',pos:'CEN',ovr:74,nat:'CRO'},{n:'Oyarzabal',pos:'ATT',ovr:83,nat:'ESP',age:29},{n:'Kubo',pos:'ATT',ovr:81,nat:'JPN',age:25},{n:'Barrenetxea',pos:'ATT',ovr:76,nat:'ESP'}],
    ...
    'Fenerbahce': [{n:'Ederson',pos:'POR',ovr:78,nat:'BRA',age:32},{n:'Skriniar',pos:'DIF',ovr:79,nat:'SVK',age:31},{n:'Semedo',pos:'DIF',ovr:76,nat:'POR'},{n:'Ake',pos:'DIF',ovr:78,nat:'NED',age:31},{n:'Oosterwolde',pos:'DIF',ovr:74,nat:'NED'},{n:'Kante',pos:'CEN',ovr:79,nat:'FRA',age:35},{n:'Guendouzi',pos:'CEN',ovr:78,nat:'FRA'},{n:'Asensio',pos:'CEN',ovr:79,nat:'ESP',age:30},{n:'Irfan Can',pos:'CEN',ovr:75,nat:'TUR'},{n:'Lukaku',pos:'ATT',ovr:82,nat:'BEL'},{n:'Aktuerkoglu',pos:'ATT',ovr:78,nat:'TUR'}],
