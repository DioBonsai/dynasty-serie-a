...
/* ============================================================
  ...
  const SERIE_A_ROSTERS = {
    ...
    'Bologna': [{n:'Orsolini',pos:'CEN',q:24,nat:'ITA',age:29},{n:'Dovbyk',pos:'ATT',q:16,nat:'UKR',age:29},{n:'Skorupski',pos:'POR',q:10,nat:'POL',age:35},{n:'Bernardeschi',pos:'CEN',q:10,nat:'ITA',age:32},{n:'Piccoli',pos:'ATT',q:9,nat:'ITA',age:25},{n:'Miranda J.',pos:'DIF',q:8,nat:'ESP'},{n:'Theate',pos:'DIF',q:8,nat:'BEL'},{n:'Ferguson',pos:'CEN',q:8,nat:'SCO',age:26},{n:'Cambiaghi',pos:'CEN',q:8,nat:'ITA'},{n:'Pobega',pos:'CEN',q:7,nat:'ITA'},{n:'Odgaard',pos:'CEN',q:7,nat:'DEN'},{n:'Mbangula',pos:'CEN',q:7,nat:'BEL'},{n:'Heggem',pos:'DIF',q:6,nat:'NOR'},{n:'Holm',pos:'DIF',q:6,nat:'SWE'},{n:'Zortea',pos:'DIF',q:6,nat:'ITA'},{n:'Vitik',pos:'DIF',q:4,nat:'CZE'},{n:'Amondarain',pos:'CEN',q:4,nat:'ARG'},{n:'Moro N.',pos:'CEN',q:4,nat:'CRO'},{n:'Helland',pos:'DIF',q:3,nat:'NOR'},{n:'Pessina Mas.',pos:'POR',q:2,nat:'ITA'},{n:'Casale',pos:'DIF',q:2,nat:'ITA'},{n:'Alhassane',pos:'DIF',q:2,nat:'NIG'},{n:'El Azzouzi O.',pos:'CEN',q:2,nat:'MAR'},{n:'Enem',pos:'ATT',q:2,nat:'NED'},{n:'Happonen',pos:'POR',q:1,nat:'FIN'},{n:'De Silvestri',pos:'DIF',q:1,nat:'ITA'},{n:'Libra',pos:'CEN',q:1,nat:'VEN'}],
    'Lazio': [{n:'Zaccagni',pos:'CEN',q:16,nat:'ITA',age:31},{n:'Gudmundsson A.',pos:'CEN',q:13,nat:'ISL'},{n:'Taylor K.',pos:'CEN',q:13,nat:'NED'},{n:'Mandas',pos:'POR',q:11,nat:'GRE'},{n:'Frattesi',pos:'CEN',q:11,nat:'ITA',age:27},{n:'Pinamonti',pos:'ATT',q:11,nat:'ITA',age:27},{n:'Cancellieri',pos:'CEN',q:10,nat:'ITA'},{n:'Isaksen',pos:'CEN',q:9,nat:'DEN',age:25},{n:'Doekhi',pos:'DIF',q:8,nat:'NED'},{n:'Noslin',pos:'ATT',q:8,nat:'NED'},{n:'Tavares N.',pos:'DIF',q:7,nat:'POR'},{n:'Marusic',pos:'DIF',q:6,nat:'MNE'},{n:'Sutalo J.',pos:'DIF',q:6,nat:'CRO'},{n:'Leite',pos:'DIF',q:6,nat:'POR'},{n:'Rovella',pos:'CEN',q:6,nat:'ITA',age:24},{n:'Pedraza',pos:'DIF',q:5,nat:'ESP'},{n:'Provstgaard',pos:'DIF',q:4,nat:'DEN'},{n:'Floriani Mussolini',pos:'DIF',q:4,nat:'ITA'},{n:'Dele-Bashiru',pos:'CEN',q:4,nat:'NGA'},{n:'Belahyane',pos:'CEN',q:3,nat:'MAR'},{n:'Cataldi',pos:'CEN',q:3,nat:'ITA',age:29},{n:'Motta',pos:'POR',q:1,nat:'ITA'},{n:'Renzetti',pos:'POR',q:1,nat:'ITA'},{n:'Patric',pos:'DIF',q:1,nat:'ESP'},{n:'Lazzari',pos:'DIF',q:1,nat:'ITA'},{n:'Pellegrini Lu.',pos:'DIF',q:1,nat:'ITA'},{n:'Przyborek',pos:'CEN',q:1,nat:'POL'}],
    'Torino': [{n:'Simeone',pos:'ATT',q:14,nat:'ARG',age:31},{n:'Vlasic',pos:'CEN',q:12,nat:'CRO',age:29},{n:'Adams C.',pos:'ATT',q:11,nat:'SCO',age:30},{n:'Mandragora',pos:'CEN',q:10,nat:'ITA',age:29},{n:'Perri',pos:'POR',q:9,nat:'BRA'},{n:'Casadei',pos:'CEN',q:9,nat:'ITA',age:23},{n:'Comuzzo',pos:'DIF',q:8,nat:'ITA'},{n:'Belghali',pos:'DIF',q:8,nat:'ALG'},{n:'Coco',pos:'DIF',q:7,nat:'EQG'},{n:'Ismajli',pos:'DIF',q:7,nat:'ALB'},{n:'Fortini',pos:'DIF',q:7,nat:'ITA'},{n:'Cacciamani',pos:'CEN',q:7,nat:'ITA'},{n:'Braganca',pos:'CEN',q:7,nat:'POR'},{n:'Fitz-Jim',pos:'CEN',q:6,nat:'NED'},{n:'Gineitis',pos:'CEN',q:6,nat:'LTU'},{n:'Oristanio',pos:'CEN',q:6,nat:'ITA'},{n:'Zapata D.',pos:'ATT',q:6,nat:'COL'},{n:'Comert',pos:'DIF',q:5,nat:'SUI'},{n:'Patterson',pos:'DIF',q:5,nat:'SCO'},{n:'Rodriguez R.',pos:'DIF',q:5,nat:'SUI'},{n:'Ilkhan',pos:'CEN',q:4,nat:'TUR'},{n:'Aboukhlal',pos:'CEN',q:3,nat:'MAR'},{n:'Kulenovic',pos:'ATT',q:3,nat:'CRO'},{n:'Mascardi',pos:'POR',q:1,nat:'ITA'},{n:'Siviero',pos:'POR',q:1,nat:'ITA'},{n:'Biraghi',pos:'DIF',q:1,nat:'ITA'}],
    ...
    'Genoa': [{n:'Baldanzi',pos:'CEN',q:11,nat:'ITA'},{n:'Ostigard',pos:'DIF',q:10,nat:'NOR'},{n:'Colombo',pos:'ATT',q:10,nat:'ITA',age:24},{n:'Vasquez',pos:'DIF',q:9,nat:'MEX'},{n:'Osmajic',pos:'ATT',q:9,nat:'MNE'},{n:'Vitinha O.',pos:'ATT',q:8,nat:'POR'},{n:'Bijlow',pos:'POR',q:7,nat:'NED'},{n:'Frendrup',pos:'CEN',q:7,nat:'DEN',age:26},{n:'Sow',pos:'CEN',q:7,nat:'SUI'},{n:'El Shaarawy',pos:'CEN',q:7,nat:'ITA',age:33},{n:'Marcandalli',pos:'DIF',q:6,nat:'ITA'},{n:'Ellertsson',pos:'CEN',q:6,nat:'ISL'},{n:'Messias',pos:'CEN',q:5,nat:'BRA'},{n:'Ehizibue',pos:'DIF',q:4,nat:'NED'},{n:'Amorim',pos:'CEN',q:4,nat:'BRA'},{n:'Meichtry',pos:'CEN',q:4,nat:'SUI'},{n:'Traorè Hj.',pos:'CEN',q:4,nat:'CIV'},{n:'Mitaj',pos:'DIF',q:3,nat:'ALB'},{n:'Drameh',pos:'DIF',q:3,nat:'ENG'},{n:'Havel',pos:'ATT',q:3,nat:'AUT'},{n:'Otoa',pos:'DIF',q:2,nat:'DEN'},{n:'Sabelli',pos:'DIF',q:2,nat:'ITA'},{n:'Sommariva',pos:'POR',q:1,nat:'ITA'},{n:'Stolz',pos:'POR',q:1,nat:'AUT'},{n:'Puczka',pos:'DIF',q:1,nat:'AUT'},{n:'Venturino',pos:'CEN',q:1,nat:'ITA'},{n:'Robinho Junior',pos:'ATT',q:1,nat:'BRA'}],
    'Sassuolo': [{n:'Berardi',pos:'ATT',q:18,nat:'ITA',age:32},{n:'Laurientè',pos:'ATT',q:16,nat:'FRA',age:28},{n:'Esposito Se.',pos:'ATT',q:13,nat:'ITA',age:22},{n:'Bowie',pos:'ATT',q:11,nat:'SCO'},{n:'Thorstvedt',pos:'CEN',q:10,nat:'NOR'},{n:'Adzic',pos:'CEN',q:9,nat:'MNE'},{n:'Volpato',pos:'CEN',q:9,nat:'AUS',age:23},{n:'Konè I.',pos:'CEN',q:8,nat:'CAN'},{n:'Idzes',pos:'DIF',q:7,nat:'IDN'},{n:'Doig',pos:'DIF',q:7,nat:'SCO'},{n:'Leysen F.',pos:'DIF',q:7,nat:'BEL'},{n:'Matic',pos:'CEN',q:7,nat:'SRB'},{n:'Muric',pos:'POR',q:6,nat:'KVX'},{n:'Obrador',pos:'DIF',q:6,nat:'ESP'},{n:'Caleta-Car',pos:'DIF',q:6,nat:'CRO'},{n:'Bakola',pos:'CEN',q:6,nat:'FRA'},{n:'Cinquegrano',pos:'DIF',q:4,nat:'ITA'},{n:'Dominguez B.',pos:'CEN',q:4,nat:'ARG'},{n:'Walukiewicz',pos:'DIF',q:3,nat:'POL'},{n:'Odenthal',pos:'DIF',q:3,nat:'NED'},{n:'Sulemana I.',pos:'CEN',q:3,nat:'GHA'},{n:'Lipani',pos:'CEN',q:3,nat:'ITA'},{n:'Candè',pos:'DIF',q:2,nat:'GNB'},{n:'Russo A.',pos:'POR',q:1,nat:'ITA'},{n:'Turati',pos:'POR',q:1,nat:'ITA'},{n:'Satalino',pos:'POR',q:1,nat:'ITA'},{n:'Van Der Brempt',pos:'DIF',q:1,nat:'BEL'},{n:'Pieragnolo',pos:'DIF',q:1,nat:'ITA'},{n:'Boloca',pos:'CEN',q:1,nat:'ITA',age:27}],
 ...
 ,
  ...
  const EURO_ROSTERS = {
    ...
    'Manchester City': [{n:'Donnarumma',pos:'POR',ovr:89,nat:'ITA',age:27},{n:'Dias',pos:'DIF',ovr:86,nat:'POR',age:29},{n:'Gvardiol',pos:'DIF',ovr:85,nat:'CRO',age:24},{n:'Ait-Nouri',pos:'DIF',ovr:81,nat:'ALG',age:25},{n:'Rico Lewis',pos:'DIF',ovr:80,nat:'ENG'},{n:'Foden',pos:'CEN',ovr:88,nat:'ENG',age:26},{n:'Enzo Fernandez',pos:'CEN',ovr:86,nat:'ARG',age:25},{n:'Kovacic',pos:'CEN',ovr:82,nat:'CRO',age:32},{n:'Cherki',pos:'CEN',ovr:83,nat:'FRA'},{n:'Haaland',pos:'ATT',ovr:94,nat:'NOR',age:26},{n:'Doku',pos:'ATT',ovr:85,nat:'BEL',age:24},{n:'Ndiaye',pos:'ATT',ovr:80,nat:'SEN'}],
    'Bayern Monaco': [{n:'Neuer',pos:'POR',ovr:84,nat:'GER',age:40},{n:'Upamecano',pos:'DIF',ovr:85,nat:'FRA',age:27},{n:'Kim Min-jae',pos:'DIF',ovr:84,nat:'KOR',age:30},{n:'Tah',pos:'DIF',ovr:84,nat:'GER',age:30},{n:'Davies',pos:'DIF',ovr:85,nat:'CAN',age:26},{n:'Kimmich',pos:'CEN',ovr:88,nat:'GER',age:31},{n:'Musiala',pos:'CEN',ovr:89,nat:'GER',age:23},{n:'Olise',pos:'CEN',ovr:87,nat:'FRA',age:24},{n:'Pavlovic',pos:'CEN',ovr:81,nat:'SRB'},{n:'Kane',pos:'ATT',ovr:90,nat:'ENG',age:33},{n:'Diaz',pos:'ATT',ovr:85,nat:'COL',age:30},{n:'Gnabry',pos:'ATT',ovr:80,nat:'GER',age:31}],
    'Paris Saint-Germain': [{n:'Chevalier',pos:'POR',ovr:84,nat:'FRA'},{n:'Hakimi',pos:'DIF',ovr:88,nat:'MAR',age:27},{n:'Marquinhos',pos:'DIF',ovr:85,nat:'BRA',age:32},{n:'Nuno Mendes',pos:'DIF',ovr:85,nat:'POR',age:24},{n:'Zabarnyi',pos:'DIF',ovr:80,nat:'UKR'},{n:'Vitinha',pos:'CEN',ovr:87,nat:'POR',age:26},{n:'Joao Neves',pos:'CEN',ovr:86,nat:'POR',age:21},{n:'Zaire-Emery',pos:'CEN',ovr:84,nat:'FRA',age:20},{n:'Fabian Ruiz',pos:'CEN',ovr:84,nat:'ESP',age:30},{n:'Dembele',pos:'ATT',ovr:91,nat:'FRA',age:29},{n:'Doue',pos:'ATT',ovr:87,nat:'FRA',age:20},{n:'Kvaratskhelia',pos:'ATT',ovr:87,nat:'GEO',age:25}],
    'Liverpool': [{n:'Alisson',pos:'POR',ovr:87,nat:'BRA',age:34},{n:'Van Dijk',pos:'DIF',ovr:87,nat:'NED',age:35},{n:'Araujo',pos:'DIF',ovr:82,nat:'URU',age:27},{n:'Frimpong',pos:'DIF',ovr:81,nat:'NED',age:26},{n:'Gomez',pos:'DIF',ovr:79,nat:'ENG'},{n:'Wirtz',pos:'CEN',ovr:88,nat:'GER',age:23},{n:'Mac Allister',pos:'CEN',ovr:86,nat:'ARG',age:27},{n:'Szoboszlai',pos:'CEN',ovr:85,nat:'HUN',age:26},{n:'Gravenberch',pos:'CEN',ovr:84,nat:'NED',age:24},{n:'Isak',pos:'ATT',ovr:88,nat:'SWE',age:27},{n:'Gakpo',pos:'ATT',ovr:83,nat:'NED',age:27},{n:'Ekitike',pos:'ATT',ovr:82,nat:'FRA',age:24}],
    ...
    'Chelsea': [{n:'E. Martinez',pos:'POR',ovr:84,nat:'ARG',age:34},{n:'James',pos:'DIF',ovr:82,nat:'ENG',age:26},{n:'Colwill',pos:'DIF',ovr:83,nat:'ENG',age:23},{n:'Fofana',pos:'DIF',ovr:81,nat:'FRA',age:26},{n:'Gusto',pos:'DIF',ovr:80,nat:'FRA'},{n:'Caicedo',pos:'CEN',ovr:85,nat:'ECU',age:24},{n:'Palmer',pos:'CEN',ovr:87,nat:'ENG',age:24},{n:'Barco',pos:'CEN',ovr:78,nat:'ARG'},{n:'Joao Pedro',pos:'ATT',ovr:83,nat:'BRA',age:24},{n:'Estevao',pos:'ATT',ovr:83,nat:'BRA',age:19},{n:'Neto',pos:'ATT',ovr:81,nat:'POR'},{n:'Gittens',pos:'ATT',ovr:78,nat:'ENG'}],
    'Borussia Dortmund': [{n:'Kobel',pos:'POR',ovr:84,nat:'SUI',age:29},{n:'Schlotterbeck',pos:'DIF',ovr:83,nat:'GER',age:27},{n:'Anton',pos:'DIF',ovr:79,nat:'GER'},{n:'Bensebaini',pos:'DIF',ovr:79,nat:'ALG'},{n:'Ryerson',pos:'DIF',ovr:78,nat:'NOR'},{n:'Jobe Bellingham',pos:'CEN',ovr:81,nat:'ENG',age:21},{n:'Nmecha',pos:'CEN',ovr:78,nat:'GER'},{n:'Sabitzer',pos:'CEN',ovr:79,nat:'AUT'},{n:'Can',pos:'CEN',ovr:77,nat:'GER'},{n:'Guirassy',pos:'ATT',ovr:85,nat:'GUI',age:30},{n:'Beier',pos:'ATT',ovr:79,nat:'GER'},{n:'Fabio Silva',pos:'ATT',ovr:76,nat:'POR'}],
    'Atletico Madrid': [{n:'Oblak',pos:'POR',ovr:86,nat:'SVN',age:33},{n:'Le Normand',pos:'DIF',ovr:83,nat:'ESP',age:30},{n:'Hancko',pos:'DIF',ovr:82,nat:'SVK'},{n:'Grimaldo',pos:'DIF',ovr:83,nat:'ESP'},{n:'Pubill',pos:'DIF',ovr:78,nat:'ESP'},{n:'Koke',pos:'CEN',ovr:80,nat:'ESP',age:34},{n:'Barrios',pos:'CEN',ovr:81,nat:'ESP'},{n:'Baena',pos:'CEN',ovr:83,nat:'ESP',age:25},{n:'Llorente',pos:'CEN',ovr:80,nat:'ESP'},{n:'Julian Alvarez',pos:'ATT',ovr:88,nat:'ARG',age:26},{n:'Lookman',pos:'ATT',ovr:84,nat:'NGA',age:28},{n:'Sorloth',pos:'ATT',ovr:82,nat:'NOR',age:30}],
    'Bayer Leverkusen': [{n:'Flekken',pos:'POR',ovr:80,nat:'NED'},{n:'Tapsoba',pos:'DIF',ovr:81,nat:'BFA',age:27},{n:'Hincapie',pos:'DIF',ovr:82,nat:'ECU',age:24},{n:'Grimaldo',pos:'DIF',ovr:84,nat:'ESP',age:30},{n:'Andrich',pos:'CEN',ovr:78,nat:'GER'},{n:'Aleix Garcia',pos:'CEN',ovr:81,nat:'ESP'},{n:'Palacios',pos:'CEN',ovr:77,nat:'ARG'},{n:'Tillman',pos:'CEN',ovr:79,nat:'USA'},{n:'Schick',pos:'ATT',ovr:82,nat:'CZE',age:30},{n:'Boniface',pos:'ATT',ovr:80,nat:'NGA',age:26},{n:'Poku',pos:'ATT',ovr:76,nat:'NED'}],
    'Manchester United': [{n:'Onana',pos:'POR',ovr:79,nat:'CMR',age:30},{n:'De Ligt',pos:'DIF',ovr:83,nat:'NED',age:27},{n:'Lisandro Martinez',pos:'DIF',ovr:82,nat:'ARG',age:28},{n:'Dalot',pos:'DIF',ovr:78,nat:'POR',age:27},{n:'Shaw',pos:'DIF',ovr:79,nat:'ENG',age:31},{n:'Bruno Fernandes',pos:'CEN',ovr:87,nat:'POR',age:32},{n:'Casemiro',pos:'CEN',ovr:80,nat:'BRA',age:34},{n:'Mainoo',pos:'CEN',ovr:79,nat:'ENG',age:21},{n:'Ugarte',pos:'CEN',ovr:78,nat:'URU'},{n:'Cunha',pos:'ATT',ovr:83,nat:'BRA',age:27},{n:'Mbeumo',pos:'ATT',ovr:82,nat:'CMR',age:27},{n:'Sesko',pos:'ATT',ovr:80,nat:'SVN',age:23}],
    'Tottenham': [{n:'Vicario',pos:'POR',ovr:81,nat:'ITA',age:29},{n:'Romero',pos:'DIF',ovr:84,nat:'ARG',age:28},{n:'Van de Ven',pos:'DIF',ovr:82,nat:'NED',age:25},{n:'Udogie',pos:'DIF',ovr:79,nat:'ITA',age:24},{n:'Porro',pos:'DIF',ovr:80,nat:'ESP',age:27},{n:'Bissouma',pos:'CEN',ovr:80,nat:'MLI',age:30},{n:'Bentancur',pos:'CEN',ovr:79,nat:'URU',age:29},{n:'Maddison',pos:'CEN',ovr:82,nat:'ENG',age:30},{n:'Kudus',pos:'ATT',ovr:81,nat:'GHA',age:25},{n:'Richarlison',pos:'ATT',ovr:79,nat:'BRA',age:29},{n:'Solanke',pos:'ATT',ovr:80,nat:'ENG',age:29},{n:'Johnson',pos:'ATT',ovr:78,nat:'WAL'}],
    'Benfica': [{n:'Trubin',pos:'POR',ovr:82,nat:'UKR',age:24},{n:'Antonio Silva',pos:'DIF',ovr:83,nat:'POR',age:22},{n:'Otamendi',pos:'DIF',ovr:78,nat:'ARG',age:38},{n:'Bah',pos:'DIF',ovr:77,nat:'DEN'},{n:'Kokcu',pos:'CEN',ovr:80,nat:'TUR'},{n:'Florentino',pos:'CEN',ovr:76,nat:'POR'},{n:'Barrenechea',pos:'CEN',ovr:77,nat:'ARG'},{n:'Richard Rios',pos:'CEN',ovr:79,nat:'COL',age:26},{n:'Akturkoglu',pos:'ATT',ovr:78,nat:'TUR',age:27},{n:'Pavlidis',pos:'ATT',ovr:81,nat:'GRE'},{n:'Aursnes',pos:'CEN',ovr:75,nat:'NOR'}],
    'Porto': [{n:'Diogo Costa',pos:'POR',ovr:85,nat:'POR',age:27},{n:'Nehuen Perez',pos:'DIF',ovr:78,nat:'ARG',age:27},{n:'Zaidu',pos:'DIF',ovr:75,nat:'NGA'},{n:'Bednarek',pos:'DIF',ovr:76,nat:'POL'},{n:'Eustaquio',pos:'CEN',ovr:78,nat:'CAN',age:28},{n:'Alan Varela',pos:'CEN',ovr:80,nat:'ARG'},{n:'Gabri Veiga',pos:'CEN',ovr:79,nat:'ESP'},{n:'Rodrigo Mora',pos:'CEN',ovr:78,nat:'POR'},{n:'Pepe',pos:'ATT',ovr:77,nat:'BRA'},{n:'Samu',pos:'ATT',ovr:78,nat:'ESP',age:24},{n:'Luuk de Jong',pos:'ATT',ovr:76,nat:'NED'},{n:'Borja Sainz',pos:'ATT',ovr:77,nat:'ESP'}],
    'Ajax': [{n:'Jaros',pos:'POR',ovr:75,nat:'CZE'},{n:'Sutalo',pos:'DIF',ovr:76,nat:'CRO'},{n:'Rensch',pos:'DIF',ovr:75,nat:'NED'},{n:'Baas',pos:'DIF',ovr:73,nat:'NED'},{n:'Taylor',pos:'DIF',ovr:74,nat:'NED'},{n:'Berghuis',pos:'CEN',ovr:77,nat:'NED',age:34},{n:'Klaassen',pos:'CEN',ovr:76,nat:'NED'},{n:'Gloukh',pos:'CEN',ovr:77,nat:'ISR'},{n:'Godts',pos:'ATT',ovr:78,nat:'BEL'},{n:'Traore',pos:'ATT',ovr:74,nat:'BFA'},{n:'Weghorst',pos:'ATT',ovr:75,nat:'NED',age:33}],
    'Sporting Lisbona': [{n:'Israel',pos:'POR',ovr:78,nat:'URU'},{n:'Debast',pos:'DIF',ovr:78,nat:'BEL'},{n:'St. Juste',pos:'DIF',ovr:77,nat:'NED'},{n:'Quaresma',pos:'DIF',ovr:75,nat:'POR'},{n:'Morita',pos:'CEN',ovr:76,nat:'JPN'},{n:'Zalazar',pos:'CEN',ovr:76,nat:'URU'},{n:'Pote',pos:'CEN',ovr:80,nat:'POR',age:27},{n:'Trincao',pos:'ATT',ovr:80,nat:'POR',age:26},{n:'Geny Catamo',pos:'ATT',ovr:77,nat:'MOZ'},{n:'Luis Suarez',pos:'ATT',ovr:79,nat:'COL',age:21},{n:'Fotis Ioannidis',pos:'ATT',ovr:77,nat:'GRE'}],
    'RB Lipsia': [{n:'Gulacsi',pos:'POR',ovr:78,nat:'HUN',age:35},{n:'Henrichs',pos:'DIF',ovr:77,nat:'GER'},{n:'Orban',pos:'DIF',ovr:78,nat:'HUN',age:28},{n:'Simakan',pos:'DIF',ovr:77,nat:'FRA'},{n:'Baumgartner',pos:'CEN',ovr:80,nat:'AUT',age:27},{n:'Schlager',pos:'CEN',ovr:77,nat:'AUT'},{n:'Diomande',pos:'CEN',ovr:76,nat:'CIV'},{n:'Nusa',pos:'ATT',ovr:78,nat:'NOR'},{n:'Openda',pos:'ATT',ovr:81,nat:'BEL'},{n:'Konate',pos:'ATT',ovr:74,nat:'FRA'}],
    'Marsiglia': [{n:'Rulli',pos:'POR',ovr:79,nat:'ARG',age:34},{n:'Balerdi',pos:'DIF',ovr:79,nat:'ARG',age:27},{n:'Egan-Riley',pos:'DIF',ovr:76,nat:'ENG'},{n:'Emerson',pos:'DIF',ovr:77,nat:'ITA'},{n:'Hojbjerg',pos:'CEN',ovr:79,nat:'DEN',age:30},{n:'Rongier',pos:'CEN',ovr:76,nat:'FRA'},{n:'ORiley',pos:'CEN',ovr:78,nat:'DEN'},{n:'Vermeeren',pos:'CEN',ovr:74,nat:'BEL'},{n:'Weah',pos:'DIF',ovr:77,nat:'USA'},{n:'Greenwood',pos:'ATT',ovr:84,nat:'ENG',age:24},{n:'Aubameyang',pos:'ATT',ovr:78,nat:'GAB',age:37}],
    'Monaco': [{n:'Kohn',pos:'POR',ovr:77,nat:'SUI'},{n:'Singo',pos:'DIF',ovr:78,nat:'CIV',age:25},{n:'Salisu',pos:'DIF',ovr:78,nat:'GHA'},{n:'Vanderson',pos:'DIF',ovr:76,nat:'BRA'},{n:'Zakaria',pos:'CEN',ovr:78,nat:'SUI',age:29},{n:'Golovin',pos:'CEN',ovr:80,nat:'RUS',age:30},{n:'Camara',pos:'CEN',ovr:76,nat:'SEN'},{n:'Akliouche',pos:'ATT',ovr:79,nat:'FRA',age:22},{n:'Ben Seghir',pos:'ATT',ovr:76,nat:'MAR'},{n:'Biereth',pos:'ATT',ovr:78,nat:'DEN'},{n:'Ilenikhena',pos:'ATT',ovr:75,nat:'NGA'},{n:'Balogun',pos:'ATT',ovr:77,nat:'USA'}],
    'West Ham': [{n:'Hermansen',pos:'POR',ovr:78,nat:'DEN'},{n:'Walker-Peters',pos:'DIF',ovr:77,nat:'ENG'},{n:'Kilman',pos:'DIF',ovr:76,nat:'ENG'},{n:'Mavropanos',pos:'DIF',ovr:74,nat:'GRE'},{n:'Todibo',pos:'DIF',ovr:75,nat:'FRA'},{n:'Soucek',pos:'CEN',ovr:76,nat:'CZE'},{n:'Alvarez',pos:'CEN',ovr:78,nat:'MEX',age:27},{n:'Bowen',pos:'ATT',ovr:82,nat:'ENG',age:29},{n:'Fullkrug',pos:'ATT',ovr:78,nat:'GER',age:33},{n:'Wilson',pos:'ATT',ovr:75,nat:'ENG'}],
    'Villarreal': [{n:'Tenas',pos:'POR',ovr:75,nat:'ESP'},{n:'Foyth',pos:'DIF',ovr:79,nat:'ARG',age:28},{n:'Veiga',pos:'DIF',ovr:78,nat:'POR'},{n:'Cardona',pos:'DIF',ovr:74,nat:'ESP'},{n:'Pedraza',pos:'DIF',ovr:74,nat:'ESP'},{n:'Parejo',pos:'CEN',ovr:79,nat:'ESP',age:37},{n:'Partey',pos:'CEN',ovr:78,nat:'GHA',age:32},{n:'Comesana',pos:'CEN',ovr:74,nat:'ESP'},{n:'Pepe',pos:'ATT',ovr:80,nat:'CIV',age:27},{n:'Moreno',pos:'ATT',ovr:79,nat:'ESP',age:28},{n:'Mikautadze',pos:'ATT',ovr:76,nat:'GEO'}],
    'Real Sociedad': [{n:'Remiro',pos:'POR',ovr:80,nat:'ESP',age:31},{n:'Zubeldia',pos:'DIF',ovr:76,nat:'ESP'},{n:'Aramburu',pos:'DIF',ovr:73,nat:'VEN'},{n:'Caleta-Car',pos:'DIF',ovr:75,nat:'CRO'},{n:'Aihen Munoz',pos:'DIF',ovr:73,nat:'ESP'},{n:'Brais Mendez',pos:'CEN',ovr:78,nat:'ESP',age:29},{n:'Zakharyan',pos:'CEN',ovr:77,nat:'RUS'},{n:'Sucic',pos:'CEN',ovr:74,nat:'CRO'},{n:'Oyarzabal',pos:'ATT',ovr:83,nat:'ESP',age:29},{n:'Kubo',pos:'ATT',ovr:81,nat:'JPN',age:25},{n:'Barrenetxea',pos:'ATT',ovr:76,nat:'ESP'}],
    'Eintracht Francoforte': [{n:'Koch',pos:'DIF',ovr:76,nat:'GER'},{n:'Brassier',pos:'DIF',ovr:73,nat:'FRA'},{n:'Fernandes',pos:'DIF',ovr:74,nat:'BRA'},{n:'Chandler',pos:'DIF',ovr:73,nat:'USA'},{n:'Doan',pos:'CEN',ovr:78,nat:'JPN'},{n:'Hojlund',pos:'CEN',ovr:75,nat:'DEN'},{n:'Goetze',pos:'CEN',ovr:77,nat:'GER'},{n:'Chaibi',pos:'CEN',ovr:74,nat:'ALG'},{n:'Uzun',pos:'ATT',ovr:76,nat:'TUR'},{n:'Burkardt',pos:'ATT',ovr:78,nat:'GER',age:26}],
    ...
    'Celtic': [{n:'Sinisalo',pos:'POR',ovr:73,nat:'FIN'},{n:'Carter-Vickers',pos:'DIF',ovr:77,nat:'USA'},{n:'Johnston',pos:'DIF',ovr:75,nat:'CAN'},{n:'Scales',pos:'DIF',ovr:73,nat:'IRL'},{n:'Trusty',pos:'DIF',ovr:72,nat:'USA'},{n:'McGregor',pos:'CEN',ovr:77,nat:'SCO'},{n:'McCowan',pos:'CEN',ovr:73,nat:'SCO'},{n:'Oxlade-Chamberlain',pos:'CEN',ovr:75,nat:'ENG'},{n:'Jota',pos:'ATT',ovr:78,nat:'POR',age:27},{n:'Nygren',pos:'ATT',ovr:74,nat:'SWE'},{n:'Yang',pos:'ATT',ovr:71,nat:'KOR'}],
