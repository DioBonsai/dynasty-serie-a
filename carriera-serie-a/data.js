...
/* ============================================================
 ...
 ,
  ...
  const EURO_ROSTERS = {
    ...
    'Chelsea': [{n:'E. Martinez',pos:'POR',ovr:84,nat:'ARG',age:34},{n:'James',pos:'DIF',ovr:82,nat:'ENG',age:26},{n:'Colwill',pos:'DIF',ovr:83,nat:'ENG',age:23},{n:'Fofana',pos:'DIF',ovr:81,nat:'FRA',age:26},{n:'Gusto',pos:'DIF',ovr:80,nat:'FRA',age:23},{n:'Caicedo',pos:'CEN',ovr:85,nat:'ECU',age:24},{n:'Palmer',pos:'CEN',ovr:87,nat:'ENG',age:24},{n:'Barco',pos:'CEN',ovr:78,nat:'ARG'},{n:'Joao Pedro',pos:'ATT',ovr:83,nat:'BRA',age:24},{n:'Estevao',pos:'ATT',ovr:83,nat:'BRA',age:19},{n:'Neto',pos:'ATT',ovr:81,nat:'POR',age:26},{n:'Gittens',pos:'ATT',ovr:78,nat:'ENG'}],
    'Borussia Dortmund': [{n:'Kobel',pos:'POR',ovr:84,nat:'SUI',age:29},{n:'Schlotterbeck',pos:'DIF',ovr:83,nat:'GER',age:27},{n:'Anton',pos:'DIF',ovr:79,nat:'GER',age:30},{n:'Bensebaini',pos:'DIF',ovr:79,nat:'ALG',age:31},{n:'Ryerson',pos:'DIF',ovr:78,nat:'NOR'},{n:'Jobe Bellingham',pos:'CEN',ovr:81,nat:'ENG',age:21},{n:'Nmecha',pos:'CEN',ovr:78,nat:'GER'},{n:'Sabitzer',pos:'CEN',ovr:79,nat:'AUT',age:32},{n:'Can',pos:'CEN',ovr:77,nat:'GER'},{n:'Guirassy',pos:'ATT',ovr:85,nat:'GUI',age:30},{n:'Beier',pos:'ATT',ovr:79,nat:'GER',age:24},{n:'Fabio Silva',pos:'ATT',ovr:76,nat:'POR'}],
    'Atletico Madrid': [{n:'Oblak',pos:'POR',ovr:86,nat:'SVN',age:33},{n:'Le Normand',pos:'DIF',ovr:83,nat:'ESP',age:30},{n:'Hancko',pos:'DIF',ovr:82,nat:'SVK',age:29},{n:'Grimaldo',pos:'DIF',ovr:83,nat:'ESP',age:30},{n:'Pubill',pos:'DIF',ovr:78,nat:'ESP'},{n:'Koke',pos:'CEN',ovr:80,nat:'ESP',age:34},{n:'Barrios',pos:'CEN',ovr:81,nat:'ESP',age:23},{n:'Baena',pos:'CEN',ovr:83,nat:'ESP',age:25},{n:'Llorente',pos:'CEN',ovr:80,nat:'ESP',age:31},{n:'Julian Alvarez',pos:'ATT',ovr:88,nat:'ARG',age:26},{n:'Lookman',pos:'ATT',ovr:84,nat:'NGA',age:28},{n:'Sorloth',pos:'ATT',ovr:82,nat:'NOR',age:30}],
    'Bayer Leverkusen': [{n:'Flekken',pos:'POR',ovr:80,nat:'NED',age:33},{n:'Tapsoba',pos:'DIF',ovr:81,nat:'BFA',age:27},{n:'Hincapie',pos:'DIF',ovr:82,nat:'ECU',age:24},{n:'Grimaldo',pos:'DIF',ovr:84,nat:'ESP',age:30},{n:'Andrich',pos:'CEN',ovr:78,nat:'GER'},{n:'Aleix Garcia',pos:'CEN',ovr:81,nat:'ESP',age:29},{n:'Palacios',pos:'CEN',ovr:77,nat:'ARG'},{n:'Tillman',pos:'CEN',ovr:79,nat:'USA',age:24},{n:'Schick',pos:'ATT',ovr:82,nat:'CZE',age:30},{n:'Boniface',pos:'ATT',ovr:80,nat:'NGA',age:26},{n:'Poku',pos:'ATT',ovr:76,nat:'NED'}],
    ...
    'Benfica': [{n:'Trubin',pos:'POR',ovr:82,nat:'UKR',age:24},{n:'Antonio Silva',pos:'DIF',ovr:83,nat:'POR',age:22},{n:'Otamendi',pos:'DIF',ovr:78,nat:'ARG',age:38},{n:'Bah',pos:'DIF',ovr:77,nat:'DEN'},{n:'Kokcu',pos:'CEN',ovr:80,nat:'TUR'},{n:'Florentino',pos:'CEN',ovr:76,nat:'POR'},{n:'Barrenechea',pos:'CEN',ovr:77,nat:'ARG'},{n:'Richard Rios',pos:'CEN',ovr:79,nat:'COL',age:26},{n:'Akturkoglu',pos:'ATT',ovr:78,nat:'TUR',age:27},{n:'Pavlidis',pos:'ATT',ovr:81,nat:'GRE',age:28},{n:'Aursnes',pos:'CEN',ovr:75,nat:'NOR'}],
    'Porto': [{n:'Diogo Costa',pos:'POR',ovr:85,nat:'POR',age:27},{n:'Nehuen Perez',pos:'DIF',ovr:78,nat:'ARG',age:27},{n:'Zaidu',pos:'DIF',ovr:75,nat:'NGA'},{n:'Bednarek',pos:'DIF',ovr:76,nat:'POL'},{n:'Eustaquio',pos:'CEN',ovr:78,nat:'CAN',age:28},{n:'Alan Varela',pos:'CEN',ovr:80,nat:'ARG',age:26},{n:'Gabri Veiga',pos:'CEN',ovr:79,nat:'ESP',age:24},{n:'Rodrigo Mora',pos:'CEN',ovr:78,nat:'POR'},{n:'Pepe',pos:'ATT',ovr:77,nat:'BRA'},{n:'Samu',pos:'ATT',ovr:78,nat:'ESP',age:24},{n:'Luuk de Jong',pos:'ATT',ovr:76,nat:'NED'},{n:'Borja Sainz',pos:'ATT',ovr:77,nat:'ESP'}],
    'Ajax': [{n:'Jaros',pos:'POR',ovr:75,nat:'CZE'},{n:'Sutalo',pos:'DIF',ovr:76,nat:'CRO'},{n:'Rensch',pos:'DIF',ovr:75,nat:'NED'},{n:'Baas',pos:'DIF',ovr:73,nat:'NED'},{n:'Taylor',pos:'DIF',ovr:74,nat:'NED'},{n:'Berghuis',pos:'CEN',ovr:77,nat:'NED',age:34},{n:'Klaassen',pos:'CEN',ovr:76,nat:'NED',age:32},{n:'Gloukh',pos:'CEN',ovr:77,nat:'ISR'},{n:'Godts',pos:'ATT',ovr:78,nat:'BEL'},{n:'Traore',pos:'ATT',ovr:74,nat:'BFA'},{n:'Weghorst',pos:'ATT',ovr:75,nat:'NED',age:33}],
    ...
    'Monaco': [{n:'Kohn',pos:'POR',ovr:77,nat:'SUI'},{n:'Singo',pos:'DIF',ovr:78,nat:'CIV',age:25},{n:'Salisu',pos:'DIF',ovr:78,nat:'GHA',age:26},{n:'Vanderson',pos:'DIF',ovr:76,nat:'BRA'},{n:'Zakaria',pos:'CEN',ovr:78,nat:'SUI',age:29},{n:'Golovin',pos:'CEN',ovr:80,nat:'RUS',age:30},{n:'Camara',pos:'CEN',ovr:76,nat:'SEN'},{n:'Akliouche',pos:'ATT',ovr:79,nat:'FRA',age:22},{n:'Ben Seghir',pos:'ATT',ovr:76,nat:'MAR'},{n:'Biereth',pos:'ATT',ovr:78,nat:'DEN',age:22},{n:'Ilenikhena',pos:'ATT',ovr:75,nat:'NGA'},{n:'Balogun',pos:'ATT',ovr:77,nat:'USA'}],
    ...
    'Feyenoord': [{n:'Wellenreuther',pos:'POR',ovr:74,nat:'GER'},{n:'Smal',pos:'DIF',ovr:72,nat:'NED'},{n:'Bos',pos:'DIF',ovr:70,nat:'AUS'},{n:'Hwang',pos:'CEN',ovr:75,nat:'KOR',age:30},{n:'Zerrouki',pos:'CEN',ovr:74,nat:'ALG',age:27},{n:'Moussa',pos:'ATT',ovr:73,nat:'ALG'},{n:'Kokcu',pos:'CEN',ovr:76,nat:'TUR'},{n:'Ueda',pos:'ATT',ovr:74,nat:'JPN'},{n:'Bueno',pos:'ATT',ovr:73,nat:'ESP'},{n:'Milambo',pos:'CEN',ovr:73,nat:'NED'}],
    'PSV Eindhoven': [{n:'Kovar',pos:'POR',ovr:75,nat:'CZE'},{n:'Dest',pos:'DIF',ovr:78,nat:'USA',age:25},{n:'Geertruida',pos:'DIF',ovr:79,nat:'NED',age:25},{n:'Flamingo',pos:'DIF',ovr:73,nat:'NED'},{n:'Obispo',pos:'DIF',ovr:72,nat:'CUW'},{n:'Til',pos:'CEN',ovr:75,nat:'NED'},{n:'Schouten',pos:'CEN',ovr:76,nat:'NED'},{n:'Wanner',pos:'CEN',ovr:74,nat:'AUT'},{n:'Perisic',pos:'ATT',ovr:77,nat:'CRO',age:37},{n:'Pepi',pos:'ATT',ovr:75,nat:'USA'},{n:'Man',pos:'ATT',ovr:76,nat:'ROU'}],
    'Olympiacos': [{n:'Ortega',pos:'POR',ovr:75,nat:'GER'},{n:'Saliakas',pos:'DIF',ovr:73,nat:'GRE'},{n:'Pirola',pos:'DIF',ovr:73,nat:'ITA'},{n:'Retsos',pos:'DIF',ovr:74,nat:'GRE'},{n:'Carmo',pos:'DIF',ovr:73,nat:'ANG'},{n:'Cabella',pos:'CEN',ovr:78,nat:'FRA'},{n:'Fortounis',pos:'CEN',ovr:76,nat:'GRE'},{n:'Freuler',pos:'CEN',ovr:78,nat:'SUI',age:34},{n:'Bailey',pos:'ATT',ovr:80,nat:'JAM',age:29},{n:'El Kaabi',pos:'ATT',ovr:77,nat:'MAR',age:30},{n:'Chiquinho',pos:'CEN',ovr:74,nat:'POR'}],
    'Fenerbahce': [{n:'Ederson',pos:'POR',ovr:78,nat:'BRA',age:32},{n:'Skriniar',pos:'DIF',ovr:79,nat:'SVK',age:31},{n:'Semedo',pos:'DIF',ovr:76,nat:'POR',age:32},{n:'Ake',pos:'DIF',ovr:78,nat:'NED',age:31},{n:'Oosterwolde',pos:'DIF',ovr:74,nat:'NED',age:26},{n:'Kante',pos:'CEN',ovr:79,nat:'FRA',age:35},{n:'Guendouzi',pos:'CEN',ovr:78,nat:'FRA',age:26},{n:'Asensio',pos:'CEN',ovr:79,nat:'ESP',age:30},{n:'Irfan Can',pos:'CEN',ovr:75,nat:'TUR'},{n:'Lukaku',pos:'ATT',ovr:82,nat:'BEL'},{n:'Aktuerkoglu',pos:'ATT',ovr:78,nat:'TUR',age:27}],
