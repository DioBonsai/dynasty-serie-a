...
/* ============================================================
  ...
  const SERIE_A_ROSTERS = {
    'Napoli': [{n:'Hojlund',pos:'ATT',q:28,nat:'DEN'},{n:'McTominay',pos:'CEN',q:26,nat:'SCO'},{n:'De Bruyne',pos:'CEN',q:17,nat:'BEL'},{n:'Rrahmani',pos:'DIF',q:14,nat:'KVX'},{n:'Santos A.',pos:'ATT',q:14,nat:'BRA'},{n:'Di Lorenzo',pos:'DIF',q:12,nat:'ITA'},{n:'Meret',pos:'POR',q:10,nat:'ITA'},{n:'Lobotka',pos:'CEN',q:10,nat:'SVK'},{n:'Zambo Anguissa',pos:'CEN',q:10,nat:'CMR'},{n:'Politano',pos:'CEN',q:10,nat:'ITA'},{n:'Vergara',pos:'CEN',q:9,nat:'ITA'},{n:'Spinazzola',pos:'DIF',q:8,nat:'ITA'},{n:'Buongiorno',pos:'DIF',q:6,nat:'ITA'},{n:'Badiashile',pos:'DIF',q:6,nat:'FRA'},{n:'Milinkovic-Savic V.',pos:'POR',q:5,nat:'SRB'},{n:'Beukema',pos:'DIF',q:5,nat:'NED'},{n:'Favasuli',pos:'DIF',q:5,nat:'ITA'},{n:'Neres',pos:'ATT',q:5,nat:'BRA'},{n:'Olivera',pos:'DIF',q:4,nat:'URU'},{n:'Lang',pos:'ATT',q:4,nat:'NED'},{n:'Gilmour',pos:'CEN',q:3,nat:'SCO'},{n:'Giovane',pos:'ATT',q:3,nat:'BRA'},{n:'Lucca',pos:'ATT',q:3,nat:'ITA'},{n:'Marin R.',pos:'DIF',q:2,nat:'ESP'},{n:'Contini',pos:'POR',q:1,nat:'ITA'},{n:'Marianucci',pos:'DIF',q:1,nat:'ITA'}],
    'Inter': [{n:'Martinez L.',pos:'ATT',q:34,nat:'ARG'},{n:'Dimarco',pos:'DIF',q:30,nat:'ITA'},{n:'Thuram',pos:'ATT',q:30,nat:'FRA'},{n:'Calhanoglu',pos:'CEN',q:27,nat:'TUR'},{n:'Barella',pos:'CEN',q:18,nat:'ITA'},{n:'Esposito F.P.',pos:'ATT',q:18,nat:'ITA'},{n:'Martinez Jo.',pos:'POR',q:16,nat:'ESP'},{n:'Akanji',pos:'DIF',q:15,nat:'SUI'},{n:'Bastoni',pos:'DIF',q:14,nat:'ITA'},{n:'Zielinski',pos:'CEN',q:13,nat:'POL'},{n:'Bisseck',pos:'DIF',q:12,nat:'GER'},{n:'Stones',pos:'DIF',q:12,nat:'ENG'},{n:'Jones C.',pos:'CEN',q:12,nat:'ENG'},{n:'Spence',pos:'DIF',q:11,nat:'ENG'},{n:'Diouf',pos:'CEN',q:10,nat:'FRA'},{n:'Carlos Augusto',pos:'DIF',q:9,nat:'BRA'},{n:'Sucic P.',pos:'CEN',q:8,nat:'CRO'},{n:'Bonny',pos:'ATT',q:8,nat:'CIV'},{n:'Pavard',pos:'DIF',q:6,nat:'FRA'},{n:'Luis Henrique',pos:'CEN',q:4,nat:'BRA'},{n:'Mkhitaryan',pos:'CEN',q:4,nat:'ARM'},{n:'Stankovic A.',pos:'CEN',q:2,nat:'SRB'},{n:'Di Gennaro',pos:'POR',q:1,nat:'ITA'},{n:'Provedel',pos:'POR',q:1,nat:'ITA'}],
    'Juventus': [{n:'Kolo Muani',pos:'ATT',q:24,nat:'FRA'},{n:'Woltemade',pos:'ATT',q:22,nat:'GER'},{n:'Yildiz',pos:'ATT',q:21,nat:'TUR'},{n:'Vicario',pos:'POR',q:16,nat:'ITA'},{n:'Bremer',pos:'DIF',q:16,nat:'BRA'},{n:'McKennie',pos:'CEN',q:16,nat:'USA'},{n:'Kalulu',pos:'DIF',q:13,nat:'FRA'},{n:'Conceicao',pos:'CEN',q:13,nat:'POR'},{n:'Gonzalez N.',pos:'CEN',q:13,nat:'ARG'},{n:'Alajbegovic',pos:'CEN',q:11,nat:'BIH'},{n:'Thuram K.',pos:'CEN',q:9,nat:'FRA'},{n:'Lucumì',pos:'DIF',q:8,nat:'COL'},{n:'Cambiaso',pos:'DIF',q:8,nat:'ITA'},{n:'Locatelli',pos:'CEN',q:8,nat:'ITA'},{n:'Zhegrova',pos:'CEN',q:8,nat:'KVX'},{n:'Celik',pos:'DIF',q:7,nat:'TUR'},{n:'Koopmeiners',pos:'CEN',q:7,nat:'NED'},{n:'Sarr P.',pos:'CEN',q:7,nat:'SEN'},{n:'Boga',pos:'ATT',q:6,nat:'CIV'},{n:'Gatti',pos:'DIF',q:5,nat:'ITA'},{n:'Kelly L.',pos:'DIF',q:5,nat:'ENG'},{n:'Douglas Luiz',pos:'CEN',q:4,nat:'BRA'},{n:'Milik',pos:'ATT',q:4,nat:'POL'},{n:'Ekhator',pos:'ATT',q:2,nat:'ITA'},{n:'Pinsoglio',pos:'POR',q:1,nat:'ITA'},{n:'Grabara',pos:'POR',q:1,nat:'POL'},{n:'Rugani',pos:'DIF',q:1,nat:'ITA'},{n:'Cabal',pos:'DIF',q:1,nat:'COL'}],
    'Milan': [{n:'Ramos G.',pos:'ATT',q:26,nat:'POR'},{n:'Pulisic',pos:'CEN',q:24,nat:'USA'},{n:'Rabiot',pos:'CEN',q:23,nat:'FRA'},{n:'Maignan',pos:'POR',q:14,nat:'FRA'},{n:'Pavlovic',pos:'DIF',q:13,nat:'SRB'},{n:'Moreira',pos:'CEN',q:13,nat:'BEL'},{n:'Gila',pos:'DIF',q:12,nat:'ESP'},{n:'Modric',pos:'CEN',q:12,nat:'CRO'},{n:'Saelemaekers',pos:'CEN',q:10,nat:'BEL'},{n:'Bartesaghi',pos:'DIF',q:8,nat:'ITA'},{n:'Chukwueze',pos:'CEN',q:8,nat:'NGA'},{n:'Hutchinson',pos:'CEN',q:7,nat:'ENG'},{n:'Gabbia',pos:'DIF',q:6,nat:'ITA'},{n:'Tomori',pos:'DIF',q:6,nat:'ENG'},{n:'Cissè A.',pos:'CEN',q:6,nat:'ITA'},{n:'De Winter',pos:'DIF',q:5,nat:'BEL'},{n:'Jashari',pos:'CEN',q:5,nat:'SUI'},{n:'Musah',pos:'CEN',q:5,nat:'USA'},{n:'Loftus-Cheek',pos:'CEN',q:4,nat:'ENG'},{n:'Camarda',pos:'ATT',q:4,nat:'ITA'},{n:'Estupinan',pos:'DIF',q:3,nat:'ECU'},{n:'Terracciano',pos:'POR',q:1,nat:'ITA'},{n:'Torriani',pos:'POR',q:1,nat:'ITA'},{n:'Diawara S.',pos:'DIF',q:1,nat:'FRA'},{n:'Terracciano F.',pos:'DIF',q:1,nat:'ITA'},{n:'Comotto',pos:'CEN',q:1,nat:'ITA'}],
    'Atalanta': [{n:'Scamacca',pos:'ATT',q:20,nat:'ITA'},{n:'Krstovic',pos:'ATT',q:17,nat:'MNE'},{n:'Carnesecchi',pos:'POR',q:16,nat:'ITA'},{n:'De Ketelaere',pos:'ATT',q:16,nat:'BEL'},{n:'Samardzic',pos:'CEN',q:13,nat:'SRB'},{n:'Raspadori',pos:'ATT',q:13,nat:'ITA'},{n:'Ederson D.S.',pos:'CEN',q:12,nat:'BRA'},{n:'Kessiè',pos:'CEN',q:11,nat:'CIV'},{n:'Scalvini',pos:'DIF',q:10,nat:'ITA'},{n:'Rowe',pos:'CEN',q:10,nat:'ENG'},{n:'Zappacosta',pos:'DIF',q:8,nat:'ITA'},{n:'Pasalic',pos:'CEN',q:8,nat:'CRO'},{n:'Hien',pos:'DIF',q:7,nat:'SWE'},{n:'Gaetano',pos:'CEN',q:7,nat:'ITA'},{n:'Zalewski',pos:'CEN',q:7,nat:'POL'},{n:'Kolasinac',pos:'DIF',q:6,nat:'BIH'},{n:'Bernasconi',pos:'DIF',q:6,nat:'ITA'},{n:'Kristensen T.',pos:'DIF',q:6,nat:'DEN'},{n:'Elmas',pos:'CEN',q:6,nat:'MKD'},{n:'Bellanova',pos:'DIF',q:5,nat:'ITA'},{n:'Sulemana K.',pos:'ATT',q:5,nat:'GHA'},{n:'Kossounou',pos:'DIF',q:3,nat:'CIV'},{n:'Sportiello',pos:'POR',q:1,nat:'ITA'},{n:'Pompei',pos:'POR',q:1,nat:'ITA'}],
    'Roma': [{n:'Malen',pos:'ATT',q:37,nat:'NED'},{n:'Mora',pos:'CEN',q:20,nat:'POR'},{n:'Svilar',pos:'POR',q:19,nat:'SRB'},{n:'Wesley',pos:'DIF',q:18,nat:'BRA'},{n:'Molina N.',pos:'DIF',q:18,nat:'ARG'},{n:'Dybala',pos:'ATT',q:16,nat:'ARG'},{n:'Mancini',pos:'DIF',q:15,nat:'ITA'},{n:'Soulè',pos:'ATT',q:15,nat:'ARG'},{n:'Castro S.',pos:'ATT',q:14,nat:'ARG'},{n:'N\'Dicka',pos:'DIF',q:12,nat:'CIV'},{n:'Hermoso',pos:'DIF',q:11,nat:'ESP'},{n:'Konè M.',pos:'CEN',q:10,nat:'FRA'},{n:'Cristante',pos:'CEN',q:9,nat:'ITA'},{n:'Pellegrini Lo.',pos:'CEN',q:9,nat:'ITA'},{n:'Pisilli',pos:'CEN',q:8,nat:'ITA'},{n:'Koulierakis',pos:'DIF',q:7,nat:'GRE'},{n:'Balerdi',pos:'DIF',q:7,nat:'ARG'},{n:'Ghilardi',pos:'DIF',q:5,nat:'ITA'},{n:'Rensch',pos:'DIF',q:4,nat:'NED'},{n:'De Roon',pos:'CEN',q:4,nat:'NED'},{n:'Lulli',pos:'DIF',q:3,nat:'ITA'},{n:'De Marzi',pos:'POR',q:1,nat:'USA'},{n:'Gollini',pos:'POR',q:1,nat:'ITA'}],
    'Fiorentina': [{n:'Atta',pos:'CEN',q:16,nat:'FRA'},{n:'Pellegrino M.',pos:'ATT',q:16,nat:'ARG'},{n:'Mastantuono',pos:'CEN',q:14,nat:'ARG'},{n:'Beto',pos:'ATT',q:14,nat:'GNB'},{n:'Goncalves P.',pos:'CEN',q:11,nat:'POR'},{n:'De Gea',pos:'POR',q:10,nat:'ESP'},{n:'Dodò',pos:'DIF',q:9,nat:'BRA'},{n:'Dragusin',pos:'DIF',q:8,nat:'ROU'},{n:'Jimenez A.',pos:'DIF',q:8,nat:'ESP'},{n:'Fagioli',pos:'CEN',q:8,nat:'ITA'},{n:'Ndour',pos:'CEN',q:8,nat:'ITA'},{n:'Gnonto',pos:'ATT',q:7,nat:'ITA'},{n:'Viery',pos:'DIF',q:6,nat:'BRA'},{n:'Oulai',pos:'CEN',q:6,nat:'CIV'},{n:'Valdepenas',pos:'DIF',q:5,nat:'ESP'},{n:'Njie',pos:'CEN',q:5,nat:'SWE'},{n:'Parisi',pos:'DIF',q:4,nat:'ITA'},{n:'Pongracic',pos:'DIF',q:3,nat:'CRO'},{n:'Ranieri L.',pos:'DIF',q:3,nat:'ITA'},{n:'Brescianini',pos:'CEN',q:3,nat:'ITA'},{n:'Joao Mario',pos:'DIF',q:2,nat:'POR'},{n:'Christensen O.',pos:'POR',q:1,nat:'DEN'},{n:'Lezzerini',pos:'POR',q:1,nat:'ITA'}],
    'Bologna': [{n:'Orsolini',pos:'CEN',q:24,nat:'ITA'},{n:'Dovbyk',pos:'ATT',q:16,nat:'UKR'},{n:'Skorupski',pos:'POR',q:10,nat:'POL'},{n:'Bernardeschi',pos:'CEN',q:10,nat:'ITA'},{n:'Piccoli',pos:'ATT',q:9,nat:'ITA'},{n:'Miranda J.',pos:'DIF',q:8,nat:'ESP'},{n:'Theate',pos:'DIF',q:8,nat:'BEL'},{n:'Ferguson',pos:'CEN',q:8,nat:'SCO'},{n:'Cambiaghi',pos:'CEN',q:8,nat:'ITA'},{n:'Pobega',pos:'CEN',q:7,nat:'ITA'},{n:'Odgaard',pos:'CEN',q:7,nat:'DEN'},{n:'Mbangula',pos:'CEN',q:7,nat:'BEL'},{n:'Heggem',pos:'DIF',q:6,nat:'NOR'},{n:'Holm',pos:'DIF',q:6,nat:'SWE'},{n:'Zortea',pos:'DIF',q:6,nat:'ITA'},{n:'Vitik',pos:'DIF',q:4,nat:'CZE'},{n:'Amondarain',pos:'CEN',q:4,nat:'ARG'},{n:'Moro N.',pos:'CEN',q:4,nat:'CRO'},{n:'Helland',pos:'DIF',q:3,nat:'NOR'},{n:'Pessina Mas.',pos:'POR',q:2,nat:'ITA'},{n:'Casale',pos:'DIF',q:2,nat:'ITA'},{n:'Alhassane',pos:'DIF',q:2,nat:'NIG'},{n:'El Azzouzi O.',pos:'CEN',q:2,nat:'MAR'},{n:'Enem',pos:'ATT',q:2,nat:'NED'},{n:'Happonen',pos:'POR',q:1,nat:'FIN'},{n:'De Silvestri',pos:'DIF',q:1,nat:'ITA'},{n:'Libra',pos:'CEN',q:1,nat:'VEN'}],
    'Lazio': [{n:'Zaccagni',pos:'CEN',q:16,nat:'ITA'},{n:'Gudmundsson A.',pos:'CEN',q:13,nat:'ISL'},{n:'Taylor K.',pos:'CEN',q:13,nat:'NED'},{n:'Mandas',pos:'POR',q:11,nat:'GRE'},{n:'Frattesi',pos:'CEN',q:11,nat:'ITA'},{n:'Pinamonti',pos:'ATT',q:11,nat:'ITA'},{n:'Cancellieri',pos:'CEN',q:10,nat:'ITA'},{n:'Isaksen',pos:'CEN',q:9,nat:'DEN'},{n:'Doekhi',pos:'DIF',q:8,nat:'NED'},{n:'Noslin',pos:'ATT',q:8,nat:'NED'},{n:'Tavares N.',pos:'DIF',q:7,nat:'POR'},{n:'Marusic',pos:'DIF',q:6,nat:'MNE'},{n:'Sutalo J.',pos:'DIF',q:6,nat:'CRO'},{n:'Leite',pos:'DIF',q:6,nat:'POR'},{n:'Rovella',pos:'CEN',q:6,nat:'ITA'},{n:'Pedraza',pos:'DIF',q:5,nat:'ESP'},{n:'Provstgaard',pos:'DIF',q:4,nat:'DEN'},{n:'Floriani Mussolini',pos:'DIF',q:4,nat:'ITA'},{n:'Dele-Bashiru',pos:'CEN',q:4,nat:'NGA'},{n:'Belahyane',pos:'CEN',q:3,nat:'MAR'},{n:'Cataldi',pos:'CEN',q:3,nat:'ITA'},{n:'Motta',pos:'POR',q:1,nat:'ITA'},{n:'Renzetti',pos:'POR',q:1,nat:'ITA'},{n:'Patric',pos:'DIF',q:1,nat:'ESP'},{n:'Lazzari',pos:'DIF',q:1,nat:'ITA'},{n:'Pellegrini Lu.',pos:'DIF',q:1,nat:'ITA'},{n:'Przyborek',pos:'CEN',q:1,nat:'POL'}],
    'Torino': [{n:'Simeone',pos:'ATT',q:14,nat:'ARG'},{n:'Vlasic',pos:'CEN',q:12,nat:'CRO'},{n:'Adams C.',pos:'ATT',q:11,nat:'SCO'},{n:'Mandragora',pos:'CEN',q:10,nat:'ITA'},{n:'Perri',pos:'POR',q:9,nat:'BRA'},{n:'Casadei',pos:'CEN',q:9,nat:'ITA'},{n:'Comuzzo',pos:'DIF',q:8,nat:'ITA'},{n:'Belghali',pos:'DIF',q:8,nat:'ALG'},{n:'Coco',pos:'DIF',q:7,nat:'EQG'},{n:'Ismajli',pos:'DIF',q:7,nat:'ALB'},{n:'Fortini',pos:'DIF',q:7,nat:'ITA'},{n:'Cacciamani',pos:'CEN',q:7,nat:'ITA'},{n:'Braganca',pos:'CEN',q:7,nat:'POR'},{n:'Fitz-Jim',pos:'CEN',q:6,nat:'NED'},{n:'Gineitis',pos:'CEN',q:6,nat:'LTU'},{n:'Oristanio',pos:'CEN',q:6,nat:'ITA'},{n:'Zapata D.',pos:'ATT',q:6,nat:'COL'},{n:'Comert',pos:'DIF',q:5,nat:'SUI'},{n:'Patterson',pos:'DIF',q:5,nat:'SCO'},{n:'Rodriguez R.',pos:'DIF',q:5,nat:'SUI'},{n:'Ilkhan',pos:'CEN',q:4,nat:'TUR'},{n:'Aboukhlal',pos:'CEN',q:3,nat:'MAR'},{n:'Kulenovic',pos:'ATT',q:3,nat:'CRO'},{n:'Mascardi',pos:'POR',q:1,nat:'ITA'},{n:'Siviero',pos:'POR',q:1,nat:'ITA'},{n:'Biraghi',pos:'DIF',q:1,nat:'ITA'}],
    'Udinese': [{n:'Davis K.',pos:'ATT',q:19,nat:'ENG'},{n:'Zaniolo',pos:'CEN',q:17,nat:'ITA'},{n:'Solet',pos:'DIF',q:13,nat:'FRA'},{n:'Ekkelenkamp',pos:'CEN',q:13,nat:'NED'},{n:'Kamara H.',pos:'DIF',q:9,nat:'CIV'},{n:'Okoye',pos:'POR',q:8,nat:'NGA'},{n:'Vojvoda',pos:'DIF',q:8,nat:'KVX'},{n:'Karlstrom',pos:'CEN',q:8,nat:'SWE'},{n:'Unai Gomez',pos:'CEN',q:7,nat:'ESP'},{n:'Piotrowski',pos:'CEN',q:6,nat:'POL'},{n:'Gueye',pos:'ATT',q:6,nat:'SEN'},{n:'Abankwah',pos:'DIF',q:5,nat:'IRL'},{n:'Bertola',pos:'DIF',q:4,nat:'ITA'},{n:'Miller L.',pos:'CEN',q:4,nat:'SCO'},{n:'Kabasele',pos:'DIF',q:3,nat:'BEL'},{n:'Ebosse',pos:'DIF',q:3,nat:'CMR'},{n:'Zanoli',pos:'DIF',q:3,nat:'ITA'},{n:'Arizala',pos:'DIF',q:3,nat:'COL'},{n:'Palma',pos:'DIF',q:2,nat:'GER'},{n:'Zarraga',pos:'CEN',q:2,nat:'ESP'},{n:'Chakvetadze',pos:'CEN',q:2,nat:'GEO'},{n:'Jovanovic',pos:'CEN',q:2,nat:'SRB'},{n:'Padelli',pos:'POR',q:1,nat:'ITA'},{n:'Mrozek',pos:'POR',q:1,nat:'POL'},{n:'Bayo V.',pos:'ATT',q:1,nat:'CIV'}],
    'Genoa': [{n:'Baldanzi',pos:'CEN',q:11,nat:'ITA'},{n:'Ostigard',pos:'DIF',q:10,nat:'NOR'},{n:'Colombo',pos:'ATT',q:10,nat:'ITA'},{n:'Vasquez',pos:'DIF',q:9,nat:'MEX'},{n:'Osmajic',pos:'ATT',q:9,nat:'MNE'},{n:'Vitinha O.',pos:'ATT',q:8,nat:'POR'},{n:'Bijlow',pos:'POR',q:7,nat:'NED'},{n:'Frendrup',pos:'CEN',q:7,nat:'DEN'},{n:'Sow',pos:'CEN',q:7,nat:'SUI'},{n:'El Shaarawy',pos:'CEN',q:7,nat:'ITA'},{n:'Marcandalli',pos:'DIF',q:6,nat:'ITA'},{n:'Ellertsson',pos:'CEN',q:6,nat:'ISL'},{n:'Messias',pos:'CEN',q:5,nat:'BRA'},{n:'Ehizibue',pos:'DIF',q:4,nat:'NED'},{n:'Amorim',pos:'CEN',q:4,nat:'BRA'},{n:'Meichtry',pos:'CEN',q:4,nat:'SUI'},{n:'Traorè Hj.',pos:'CEN',q:4,nat:'CIV'},{n:'Mitaj',pos:'DIF',q:3,nat:'ALB'},{n:'Drameh',pos:'DIF',q:3,nat:'ENG'},{n:'Havel',pos:'ATT',q:3,nat:'AUT'},{n:'Otoa',pos:'DIF',q:2,nat:'DEN'},{n:'Sabelli',pos:'DIF',q:2,nat:'ITA'},{n:'Sommariva',pos:'POR',q:1,nat:'ITA'},{n:'Stolz',pos:'POR',q:1,nat:'AUT'},{n:'Puczka',pos:'DIF',q:1,nat:'AUT'},{n:'Venturino',pos:'CEN',q:1,nat:'ITA'},{n:'Robinho Junior',pos:'ATT',q:1,nat:'BRA'}],
    'Sassuolo': [{n:'Berardi',pos:'ATT',q:18,nat:'ITA'},{n:'Laurientè',pos:'ATT',q:16,nat:'FRA'},{n:'Esposito Se.',pos:'ATT',q:13,nat:'ITA'},{n:'Bowie',pos:'ATT',q:11,nat:'SCO'},{n:'Thorstvedt',pos:'CEN',q:10,nat:'NOR'},{n:'Adzic',pos:'CEN',q:9,nat:'MNE'},{n:'Volpato',pos:'CEN',q:9,nat:'AUS'},{n:'Konè I.',pos:'CEN',q:8,nat:'CAN'},{n:'Idzes',pos:'DIF',q:7,nat:'IDN'},{n:'Doig',pos:'DIF',q:7,nat:'SCO'},{n:'Leysen F.',pos:'DIF',q:7,nat:'BEL'},{n:'Matic',pos:'CEN',q:7,nat:'SRB'},{n:'Muric',pos:'POR',q:6,nat:'KVX'},{n:'Obrador',pos:'DIF',q:6,nat:'ESP'},{n:'Caleta-Car',pos:'DIF',q:6,nat:'CRO'},{n:'Bakola',pos:'CEN',q:6,nat:'FRA'},{n:'Cinquegrano',pos:'DIF',q:4,nat:'ITA'},{n:'Dominguez B.',pos:'CEN',q:4,nat:'ARG'},{n:'Walukiewicz',pos:'DIF',q:3,nat:'POL'},{n:'Odenthal',pos:'DIF',q:3,nat:'NED'},{n:'Sulemana I.',pos:'CEN',q:3,nat:'GHA'},{n:'Lipani',pos:'CEN',q:3,nat:'ITA'},{n:'Candè',pos:'DIF',q:2,nat:'GNB'},{n:'Russo A.',pos:'POR',q:1,nat:'ITA'},{n:'Turati',pos:'POR',q:1,nat:'ITA'},{n:'Satalino',pos:'POR',q:1,nat:'ITA'},{n:'Van Der Brempt',pos:'DIF',q:1,nat:'BEL'},{n:'Pieragnolo',pos:'DIF',q:1,nat:'ITA'},{n:'Boloca',pos:'CEN',q:1,nat:'ITA'}],
    'Frosinone': [{n:'Raimondo',pos:'ATT',q:11,nat:'ITA'},{n:'Calò',pos:'CEN',q:9,nat:'ITA'},{n:'Ghedjemis',pos:'ATT',q:9,nat:'ALG'},{n:'Kvernadze',pos:'ATT',q:9,nat:'GEO'},{n:'Bobcek',pos:'ATT',q:9,nat:'SVK'},{n:'Schmid',pos:'CEN',q:8,nat:'AUT'},{n:'Bracaglia',pos:'DIF',q:7,nat:'ITA'},{n:'Oyono A.',pos:'DIF',q:7,nat:'GAB'},{n:'Palmisani',pos:'POR',q:6,nat:'ITA'},{n:'Calvani',pos:'DIF',q:6,nat:'ITA'},{n:'Monterisi',pos:'DIF',q:6,nat:'ITA'},{n:'Zerbin',pos:'CEN',q:6,nat:'ITA'},{n:'Fini',pos:'CEN',q:5,nat:'ITA'},{n:'Masini',pos:'CEN',q:5,nat:'ITA'},{n:'Cittadini',pos:'DIF',q:4,nat:'ITA'},{n:'Terzic',pos:'DIF',q:4,nat:'SRB'},{n:'Cichella',pos:'CEN',q:4,nat:'ITA'},{n:'Grillitsch',pos:'CEN',q:4,nat:'AUT'},{n:'Birligea',pos:'ATT',q:4,nat:'ROU'},{n:'Hasa',pos:'CEN',q:3,nat:'ALB'},{n:'Akpoguma',pos:'DIF',q:2,nat:'GER'},{n:'Tchato',pos:'DIF',q:2,nat:'CMR'},{n:'Gelli F.',pos:'CEN',q:2,nat:'ITA'},{n:'Desplanches',pos:'POR',q:1,nat:'ITA'},{n:'Lolic',pos:'POR',q:1,nat:'BIH'},{n:'Pisseri',pos:'POR',q:1,nat:'ITA'},{n:'Amey',pos:'DIF',q:1,nat:'ITA'},{n:'Omar Fayed',pos:'DIF',q:1,nat:'EGY'},{n:'El Azzouzi A.',pos:'CEN',q:1,nat:'MAR'},{n:'Kone B.',pos:'CEN',q:1,nat:'CIV'}],
    'Cagliari': [{n:'Caprile',pos:'POR',q:11,nat:'ITA'},{n:'Kevin Carlos',pos:'ATT',q:11,nat:'ESP'},{n:'Maldini',pos:'ATT',q:9,nat:'ITA'},{n:'Obert',pos:'DIF',q:8,nat:'SVK'},{n:'Adopo',pos:'CEN',q:8,nat:'FRA'},{n:'Romano',pos:'CEN',q:8,nat:'ITA'},{n:'Mina',pos:'DIF',q:7,nat:'COL'},{n:'Zè Pedro',pos:'DIF',q:7,nat:'POR'},{n:'Winks',pos:'CEN',q:7,nat:'ENG'},{n:'Fazzini',pos:'CEN',q:7,nat:'ITA'},{n:'Mendy P.',pos:'ATT',q:7,nat:'SEN'},{n:'Sugawara',pos:'DIF',q:6,nat:'JPN'},{n:'Kofler',pos:'DIF',q:5,nat:'ITA'},{n:'Rodriguez Ju.',pos:'DIF',q:5,nat:'URU'},{n:'Deiola',pos:'CEN',q:5,nat:'ITA'},{n:'Felici',pos:'CEN',q:5,nat:'ITA'},{n:'Fadera',pos:'CEN',q:4,nat:'GAM'},{n:'Massolin',pos:'CEN',q:4,nat:'FRA'},{n:'Nzola',pos:'ATT',q:4,nat:'ANG'},{n:'Gagliardini',pos:'CEN',q:3,nat:'ITA'},{n:'Idrissi R.',pos:'DIF',q:2,nat:'ITA'},{n:'Sherri',pos:'POR',q:1,nat:'ALB'},{n:'Radunovic',pos:'POR',q:1,nat:'SRB'},{n:'Aurelio',pos:'DIF',q:1,nat:'ITA'},{n:'Liteta',pos:'CEN',q:1,nat:'ZAM'},{n:'Ciervo',pos:'CEN',q:1,nat:'ITA'},{n:'Trepy',pos:'ATT',q:1,nat:'FRA'}],
    'Monza': [{n:'Mangas',pos:'DIF',q:9,nat:'POR'},{n:'Colpani',pos:'CEN',q:9,nat:'ITA'},{n:'Cutrone',pos:'ATT',q:9,nat:'ITA'},{n:'Akinsanmiro',pos:'CEN',q:7,nat:'NGA'},{n:'Varela G.',pos:'ATT',q:7,nat:'POR'},{n:'Zeballos',pos:'ATT',q:7,nat:'ARG'},{n:'Birindelli',pos:'DIF',q:6,nat:'ITA'},{n:'Pessina',pos:'CEN',q:6,nat:'ITA'},{n:'Robinson J.',pos:'ATT',q:6,nat:'ENG'},{n:'Tourè I.',pos:'CEN',q:5,nat:'GER'},{n:'Mota',pos:'ATT',q:5,nat:'POR'},{n:'Thiam',pos:'POR',q:4,nat:'SEN'},{n:'Lucchesi',pos:'DIF',q:4,nat:'ITA'},{n:'Kouadio',pos:'DIF',q:4,nat:'ITA'},{n:'Carboni A.',pos:'DIF',q:4,nat:'ITA'},{n:'Folorunsho',pos:'CEN',q:4,nat:'ITA'},{n:'Ngonge',pos:'ATT',q:4,nat:'BEL'},{n:'Bakoune',pos:'DIF',q:2,nat:'ITA'},{n:'Goglichidze',pos:'DIF',q:2,nat:'GEO'},{n:'Colombo L.',pos:'CEN',q:2,nat:'ITA'},{n:'Forson O.',pos:'CEN',q:2,nat:'ENG'},{n:'Foe Ondoa',pos:'CEN',q:2,nat:'FRA'},{n:'Tornqvist',pos:'POR',q:1,nat:'SWE'},{n:'Strajnar',pos:'POR',q:1,nat:'SVN'},{n:'Antov',pos:'DIF',q:1,nat:'BUL'},{n:'Ziolkowski',pos:'DIF',q:1,nat:'POL'},{n:'Maye',pos:'DIF',q:1,nat:'FRA'},{n:'Ciurria',pos:'CEN',q:1,nat:'ITA'},{n:'Mout',pos:'CEN',q:1,nat:'ITA'}],
    'Parma': [{n:'Romero D.',pos:'ATT',q:11,nat:'ARG'},{n:'Tourè E.',pos:'ATT',q:10,nat:'MLI'},{n:'Valeri',pos:'DIF',q:9,nat:'ITA'},{n:'Delprato',pos:'DIF',q:8,nat:'ITA'},{n:'Diego Carlos',pos:'DIF',q:8,nat:'BRA'},{n:'Bernabè',pos:'CEN',q:7,nat:'ESP'},{n:'Daffara',pos:'POR',q:6,nat:'ITA'},{n:'Keita M.',pos:'CEN',q:6,nat:'BEL'},{n:'Nicolussi Caviglia',pos:'CEN',q:5,nat:'ITA'},{n:'Almqvist',pos:'CEN',q:5,nat:'SWE'},{n:'Lontani',pos:'ATT',q:5,nat:'ITA'},{n:'Troilo',pos:'DIF',q:4,nat:'ARG'},{n:'Valenti',pos:'DIF',q:4,nat:'ARG'},{n:'Britschgi',pos:'DIF',q:4,nat:'SUI'},{n:'Frigan',pos:'ATT',q:4,nat:'CRO'},{n:'Corvi',pos:'POR',q:3,nat:'ITA'},{n:'Fabbian',pos:'CEN',q:3,nat:'ITA'},{n:'Ordonez C.',pos:'CEN',q:3,nat:'ARG'},{n:'Diallo O.',pos:'CEN',q:3,nat:'ESP'},{n:'Elphege',pos:'ATT',q:3,nat:'FRA'},{n:'Drobnic',pos:'DIF',q:2,nat:'SVN'},{n:'Cremaschi',pos:'CEN',q:2,nat:'USA'},{n:'Sierro',pos:'CEN',q:2,nat:'SUI'},{n:'Ghidotti',pos:'POR',q:1,nat:'ITA'},{n:'Ndiaye',pos:'DIF',q:1,nat:'SEN'},{n:'Carboni F.',pos:'DIF',q:1,nat:'ARG'},{n:'De Martis',pos:'ATT',q:1,nat:'ARG'}],
 ...
 ,
  ...
  const EURO_ROSTERS = {
    'Real Madrid': [{n:'Courtois',pos:'POR',ovr:89,nat:'BEL'},{n:'Huijsen',pos:'DIF',ovr:85,nat:'ESP'},{n:'Militao',pos:'DIF',ovr:84,nat:'BRA'},{n:'Trent',pos:'DIF',ovr:86,nat:'ENG'},{n:'Rudiger',pos:'DIF',ovr:85,nat:'GER'},{n:'Valverde',pos:'CEN',ovr:87,nat:'URU'},{n:'Bellingham',pos:'CEN',ovr:89,nat:'ENG'},{n:'Tchouameni',pos:'CEN',ovr:85,nat:'FRA'},{n:'Camavinga',pos:'CEN',ovr:84,nat:'FRA'},{n:'Mbappe',pos:'ATT',ovr:93,nat:'FRA'},{n:'Vinicius Jr',pos:'ATT',ovr:91,nat:'BRA'},{n:'Rodrygo',pos:'ATT',ovr:85,nat:'BRA'}],
    'Manchester City': [{n:'Donnarumma',pos:'POR',ovr:89,nat:'ITA'},{n:'Dias',pos:'DIF',ovr:86,nat:'POR'},{n:'Gvardiol',pos:'DIF',ovr:85,nat:'CRO'},{n:'Ait-Nouri',pos:'DIF',ovr:81,nat:'ALG'},{n:'Rico Lewis',pos:'DIF',ovr:80,nat:'ENG'},{n:'Foden',pos:'CEN',ovr:88,nat:'ENG'},{n:'Enzo Fernandez',pos:'CEN',ovr:86,nat:'ARG'},{n:'Kovacic',pos:'CEN',ovr:82,nat:'CRO'},{n:'Cherki',pos:'CEN',ovr:83,nat:'FRA'},{n:'Haaland',pos:'ATT',ovr:94,nat:'NOR'},{n:'Doku',pos:'ATT',ovr:85,nat:'BEL'},{n:'Ndiaye',pos:'ATT',ovr:80,nat:'SEN'}],
    'Bayern Monaco': [{n:'Neuer',pos:'POR',ovr:84,nat:'GER'},{n:'Upamecano',pos:'DIF',ovr:85,nat:'FRA'},{n:'Kim Min-jae',pos:'DIF',ovr:84,nat:'KOR'},{n:'Tah',pos:'DIF',ovr:84,nat:'GER'},{n:'Davies',pos:'DIF',ovr:85,nat:'CAN'},{n:'Kimmich',pos:'CEN',ovr:88,nat:'GER'},{n:'Musiala',pos:'CEN',ovr:89,nat:'GER'},{n:'Olise',pos:'CEN',ovr:87,nat:'FRA'},{n:'Pavlovic',pos:'CEN',ovr:81,nat:'SRB'},{n:'Kane',pos:'ATT',ovr:90,nat:'ENG'},{n:'Diaz',pos:'ATT',ovr:85,nat:'COL'},{n:'Gnabry',pos:'ATT',ovr:80,nat:'GER'}],
    'Paris Saint-Germain': [{n:'Chevalier',pos:'POR',ovr:84,nat:'FRA'},{n:'Hakimi',pos:'DIF',ovr:88,nat:'MAR'},{n:'Marquinhos',pos:'DIF',ovr:85,nat:'BRA'},{n:'Nuno Mendes',pos:'DIF',ovr:85,nat:'POR'},{n:'Zabarnyi',pos:'DIF',ovr:80,nat:'UKR'},{n:'Vitinha',pos:'CEN',ovr:87,nat:'POR'},{n:'Joao Neves',pos:'CEN',ovr:86,nat:'POR'},{n:'Zaire-Emery',pos:'CEN',ovr:84,nat:'FRA'},{n:'Fabian Ruiz',pos:'CEN',ovr:84,nat:'ESP'},{n:'Dembele',pos:'ATT',ovr:91,nat:'FRA'},{n:'Doue',pos:'ATT',ovr:87,nat:'FRA'},{n:'Kvaratskhelia',pos:'ATT',ovr:87,nat:'GEO'}],
    'Liverpool': [{n:'Alisson',pos:'POR',ovr:87,nat:'BRA'},{n:'Van Dijk',pos:'DIF',ovr:87,nat:'NED'},{n:'Araujo',pos:'DIF',ovr:82,nat:'URU'},{n:'Frimpong',pos:'DIF',ovr:81,nat:'NED'},{n:'Gomez',pos:'DIF',ovr:79,nat:'ENG'},{n:'Wirtz',pos:'CEN',ovr:88,nat:'GER'},{n:'Mac Allister',pos:'CEN',ovr:86,nat:'ARG'},{n:'Szoboszlai',pos:'CEN',ovr:85,nat:'HUN'},{n:'Gravenberch',pos:'CEN',ovr:84,nat:'NED'},{n:'Isak',pos:'ATT',ovr:88,nat:'SWE'},{n:'Gakpo',pos:'ATT',ovr:83,nat:'NED'},{n:'Ekitike',pos:'ATT',ovr:82,nat:'FRA'}],
    'Barcellona': [{n:'Joan Garcia',pos:'POR',ovr:83,nat:'ESP'},{n:'Kounde',pos:'DIF',ovr:85,nat:'FRA'},{n:'Cubarsi',pos:'DIF',ovr:83,nat:'ESP'},{n:'Balde',pos:'DIF',ovr:83,nat:'ESP'},{n:'Christensen',pos:'DIF',ovr:80,nat:'DEN'},{n:'Pedri',pos:'CEN',ovr:88,nat:'ESP'},{n:'De Jong',pos:'CEN',ovr:86,nat:'NED'},{n:'Gavi',pos:'CEN',ovr:85,nat:'ESP'},{n:'Olmo',pos:'CEN',ovr:85,nat:'ESP'},{n:'Yamal',pos:'ATT',ovr:91,nat:'ESP'},{n:'Raphinha',pos:'ATT',ovr:88,nat:'BRA'},{n:'Fermin Lopez',pos:'ATT',ovr:80,nat:'ESP'}],
    'Arsenal': [{n:'Raya',pos:'POR',ovr:86,nat:'ESP'},{n:'Saliba',pos:'DIF',ovr:88,nat:'FRA'},{n:'Gabriel',pos:'DIF',ovr:86,nat:'BRA'},{n:'Timber',pos:'DIF',ovr:83,nat:'NED'},{n:'Calafiori',pos:'DIF',ovr:83,nat:'ITA'},{n:'Rice',pos:'CEN',ovr:87,nat:'ENG'},{n:'Odegaard',pos:'CEN',ovr:87,nat:'NOR'},{n:'Zubimendi',pos:'CEN',ovr:83,nat:'ESP'},{n:'Eze',pos:'CEN',ovr:84,nat:'ENG'},{n:'Saka',pos:'ATT',ovr:89,nat:'ENG'},{n:'Gyokeres',pos:'ATT',ovr:85,nat:'SWE'},{n:'Havertz',pos:'ATT',ovr:83,nat:'GER'}],
    'Chelsea': [{n:'E. Martinez',pos:'POR',ovr:84,nat:'ARG'},{n:'James',pos:'DIF',ovr:82,nat:'ENG'},{n:'Colwill',pos:'DIF',ovr:83,nat:'ENG'},{n:'Fofana',pos:'DIF',ovr:81,nat:'FRA'},{n:'Gusto',pos:'DIF',ovr:80,nat:'FRA'},{n:'Caicedo',pos:'CEN',ovr:85,nat:'ECU'},{n:'Palmer',pos:'CEN',ovr:87,nat:'ENG'},{n:'Barco',pos:'CEN',ovr:78,nat:'ARG'},{n:'Joao Pedro',pos:'ATT',ovr:83,nat:'BRA'},{n:'Estevao',pos:'ATT',ovr:83,nat:'BRA'},{n:'Neto',pos:'ATT',ovr:81,nat:'POR'},{n:'Gittens',pos:'ATT',ovr:78,nat:'ENG'}],
    'Borussia Dortmund': [{n:'Kobel',pos:'POR',ovr:84,nat:'SUI'},{n:'Schlotterbeck',pos:'DIF',ovr:83,nat:'GER'},{n:'Anton',pos:'DIF',ovr:79,nat:'GER'},{n:'Bensebaini',pos:'DIF',ovr:79,nat:'ALG'},{n:'Ryerson',pos:'DIF',ovr:78,nat:'NOR'},{n:'Jobe Bellingham',pos:'CEN',ovr:81,nat:'ENG'},{n:'Nmecha',pos:'CEN',ovr:78,nat:'GER'},{n:'Sabitzer',pos:'CEN',ovr:79,nat:'AUT'},{n:'Can',pos:'CEN',ovr:77,nat:'GER'},{n:'Guirassy',pos:'ATT',ovr:85,nat:'GUI'},{n:'Beier',pos:'ATT',ovr:79,nat:'GER'},{n:'Fabio Silva',pos:'ATT',ovr:76,nat:'POR'}],
    'Atletico Madrid': [{n:'Oblak',pos:'POR',ovr:86,nat:'SVN'},{n:'Le Normand',pos:'DIF',ovr:83,nat:'ESP'},{n:'Hancko',pos:'DIF',ovr:82,nat:'SVK'},{n:'Grimaldo',pos:'DIF',ovr:83,nat:'ESP'},{n:'Pubill',pos:'DIF',ovr:78,nat:'ESP'},{n:'Koke',pos:'CEN',ovr:80,nat:'ESP'},{n:'Barrios',pos:'CEN',ovr:81,nat:'ESP'},{n:'Baena',pos:'CEN',ovr:83,nat:'ESP'},{n:'Llorente',pos:'CEN',ovr:80,nat:'ESP'},{n:'Julian Alvarez',pos:'ATT',ovr:88,nat:'ARG'},{n:'Lookman',pos:'ATT',ovr:84,nat:'NGA'},{n:'Sorloth',pos:'ATT',ovr:82,nat:'NOR'}],
    'Bayer Leverkusen': [{n:'Flekken',pos:'POR',ovr:80,nat:'NED'},{n:'Tapsoba',pos:'DIF',ovr:81,nat:'BFA'},{n:'Hincapie',pos:'DIF',ovr:82,nat:'ECU'},{n:'Grimaldo',pos:'DIF',ovr:84,nat:'ESP'},{n:'Andrich',pos:'CEN',ovr:78,nat:'GER'},{n:'Aleix Garcia',pos:'CEN',ovr:81,nat:'ESP'},{n:'Palacios',pos:'CEN',ovr:77,nat:'ARG'},{n:'Tillman',pos:'CEN',ovr:79,nat:'USA'},{n:'Schick',pos:'ATT',ovr:82,nat:'CZE'},{n:'Boniface',pos:'ATT',ovr:80,nat:'NGA'},{n:'Poku',pos:'ATT',ovr:76,nat:'NED'}],
    'Manchester United': [{n:'Onana',pos:'POR',ovr:79,nat:'CMR'},{n:'De Ligt',pos:'DIF',ovr:83,nat:'NED'},{n:'Lisandro Martinez',pos:'DIF',ovr:82,nat:'ARG'},{n:'Dalot',pos:'DIF',ovr:78,nat:'POR'},{n:'Shaw',pos:'DIF',ovr:79,nat:'ENG'},{n:'Bruno Fernandes',pos:'CEN',ovr:87,nat:'POR'},{n:'Casemiro',pos:'CEN',ovr:80,nat:'BRA'},{n:'Mainoo',pos:'CEN',ovr:79,nat:'ENG'},{n:'Ugarte',pos:'CEN',ovr:78,nat:'URU'},{n:'Cunha',pos:'ATT',ovr:83,nat:'BRA'},{n:'Mbeumo',pos:'ATT',ovr:82,nat:'CMR'},{n:'Sesko',pos:'ATT',ovr:80,nat:'SVN'}],
    'Tottenham': [{n:'Vicario',pos:'POR',ovr:81,nat:'ITA'},{n:'Romero',pos:'DIF',ovr:84,nat:'ARG'},{n:'Van de Ven',pos:'DIF',ovr:82,nat:'NED'},{n:'Udogie',pos:'DIF',ovr:79,nat:'ITA'},{n:'Porro',pos:'DIF',ovr:80,nat:'ESP'},{n:'Bissouma',pos:'CEN',ovr:80,nat:'MLI'},{n:'Bentancur',pos:'CEN',ovr:79,nat:'URU'},{n:'Maddison',pos:'CEN',ovr:82,nat:'ENG'},{n:'Kudus',pos:'ATT',ovr:81,nat:'GHA'},{n:'Richarlison',pos:'ATT',ovr:79,nat:'BRA'},{n:'Solanke',pos:'ATT',ovr:80,nat:'ENG'},{n:'Johnson',pos:'ATT',ovr:78,nat:'WAL'}],
    'Benfica': [{n:'Trubin',pos:'POR',ovr:82,nat:'UKR'},{n:'Antonio Silva',pos:'DIF',ovr:83,nat:'POR'},{n:'Otamendi',pos:'DIF',ovr:78,nat:'ARG'},{n:'Bah',pos:'DIF',ovr:77,nat:'DEN'},{n:'Kokcu',pos:'CEN',ovr:80,nat:'TUR'},{n:'Florentino',pos:'CEN',ovr:76,nat:'POR'},{n:'Barrenechea',pos:'CEN',ovr:77,nat:'ARG'},{n:'Richard Rios',pos:'CEN',ovr:79,nat:'COL'},{n:'Akturkoglu',pos:'ATT',ovr:78,nat:'TUR'},{n:'Pavlidis',pos:'ATT',ovr:81,nat:'GRE'},{n:'Aursnes',pos:'CEN',ovr:75,nat:'NOR'}],
    'Porto': [{n:'Diogo Costa',pos:'POR',ovr:85,nat:'POR'},{n:'Nehuen Perez',pos:'DIF',ovr:78,nat:'ARG'},{n:'Zaidu',pos:'DIF',ovr:75,nat:'NGA'},{n:'Bednarek',pos:'DIF',ovr:76,nat:'POL'},{n:'Eustaquio',pos:'CEN',ovr:78,nat:'CAN'},{n:'Alan Varela',pos:'CEN',ovr:80,nat:'ARG'},{n:'Gabri Veiga',pos:'CEN',ovr:79,nat:'ESP'},{n:'Rodrigo Mora',pos:'CEN',ovr:78,nat:'POR'},{n:'Pepe',pos:'ATT',ovr:77,nat:'BRA'},{n:'Samu',pos:'ATT',ovr:78,nat:'ESP'},{n:'Luuk de Jong',pos:'ATT',ovr:76,nat:'NED'},{n:'Borja Sainz',pos:'ATT',ovr:77,nat:'ESP'}],
    'Ajax': [{n:'Jaros',pos:'POR',ovr:75,nat:'CZE'},{n:'Sutalo',pos:'DIF',ovr:76,nat:'CRO'},{n:'Rensch',pos:'DIF',ovr:75,nat:'NED'},{n:'Baas',pos:'DIF',ovr:73,nat:'NED'},{n:'Taylor',pos:'DIF',ovr:74,nat:'NED'},{n:'Berghuis',pos:'CEN',ovr:77,nat:'NED'},{n:'Klaassen',pos:'CEN',ovr:76,nat:'NED'},{n:'Gloukh',pos:'CEN',ovr:77,nat:'ISR'},{n:'Godts',pos:'ATT',ovr:78,nat:'BEL'},{n:'Traore',pos:'ATT',ovr:74,nat:'BFA'},{n:'Weghorst',pos:'ATT',ovr:75,nat:'NED'}],
    'Sporting Lisbona': [{n:'Israel',pos:'POR',ovr:78,nat:'URU'},{n:'Debast',pos:'DIF',ovr:78,nat:'BEL'},{n:'St. Juste',pos:'DIF',ovr:77,nat:'NED'},{n:'Quaresma',pos:'DIF',ovr:75,nat:'POR'},{n:'Morita',pos:'CEN',ovr:76,nat:'JPN'},{n:'Zalazar',pos:'CEN',ovr:76,nat:'URU'},{n:'Pote',pos:'CEN',ovr:80,nat:'POR'},{n:'Trincao',pos:'ATT',ovr:80,nat:'POR'},{n:'Geny Catamo',pos:'ATT',ovr:77,nat:'MOZ'},{n:'Luis Suarez',pos:'ATT',ovr:79,nat:'COL'},{n:'Fotis Ioannidis',pos:'ATT',ovr:77,nat:'GRE'}],
    'RB Lipsia': [{n:'Gulacsi',pos:'POR',ovr:78,nat:'HUN'},{n:'Henrichs',pos:'DIF',ovr:77,nat:'GER'},{n:'Orban',pos:'DIF',ovr:78,nat:'HUN'},{n:'Simakan',pos:'DIF',ovr:77,nat:'FRA'},{n:'Baumgartner',pos:'CEN',ovr:80,nat:'AUT'},{n:'Schlager',pos:'CEN',ovr:77,nat:'AUT'},{n:'Diomande',pos:'CEN',ovr:76,nat:'CIV'},{n:'Nusa',pos:'ATT',ovr:78,nat:'NOR'},{n:'Openda',pos:'ATT',ovr:81,nat:'BEL'},{n:'Konate',pos:'ATT',ovr:74,nat:'FRA'}],
    'Marsiglia': [{n:'Rulli',pos:'POR',ovr:79,nat:'ARG'},{n:'Balerdi',pos:'DIF',ovr:79,nat:'ARG'},{n:'Egan-Riley',pos:'DIF',ovr:76,nat:'ENG'},{n:'Emerson',pos:'DIF',ovr:77,nat:'ITA'},{n:'Hojbjerg',pos:'CEN',ovr:79,nat:'DEN'},{n:'Rongier',pos:'CEN',ovr:76,nat:'FRA'},{n:'ORiley',pos:'CEN',ovr:78,nat:'DEN'},{n:'Vermeeren',pos:'CEN',ovr:74,nat:'BEL'},{n:'Weah',pos:'DIF',ovr:77,nat:'USA'},{n:'Greenwood',pos:'ATT',ovr:84,nat:'ENG'},{n:'Aubameyang',pos:'ATT',ovr:78,nat:'GAB'}],
    'Monaco': [{n:'Kohn',pos:'POR',ovr:77,nat:'SUI'},{n:'Singo',pos:'DIF',ovr:78,nat:'CIV'},{n:'Salisu',pos:'DIF',ovr:78,nat:'GHA'},{n:'Vanderson',pos:'DIF',ovr:76,nat:'BRA'},{n:'Zakaria',pos:'CEN',ovr:78,nat:'SUI'},{n:'Golovin',pos:'CEN',ovr:80,nat:'RUS'},{n:'Camara',pos:'CEN',ovr:76,nat:'SEN'},{n:'Akliouche',pos:'ATT',ovr:79,nat:'FRA'},{n:'Ben Seghir',pos:'ATT',ovr:76,nat:'MAR'},{n:'Biereth',pos:'ATT',ovr:78,nat:'DEN'},{n:'Ilenikhena',pos:'ATT',ovr:75,nat:'NGA'},{n:'Balogun',pos:'ATT',ovr:77,nat:'USA'}],
    'West Ham': [{n:'Hermansen',pos:'POR',ovr:78,nat:'DEN'},{n:'Walker-Peters',pos:'DIF',ovr:77,nat:'ENG'},{n:'Kilman',pos:'DIF',ovr:76,nat:'ENG'},{n:'Mavropanos',pos:'DIF',ovr:74,nat:'GRE'},{n:'Todibo',pos:'DIF',ovr:75,nat:'FRA'},{n:'Soucek',pos:'CEN',ovr:76,nat:'CZE'},{n:'Alvarez',pos:'CEN',ovr:78,nat:'MEX'},{n:'Bowen',pos:'ATT',ovr:82,nat:'ENG'},{n:'Fullkrug',pos:'ATT',ovr:78,nat:'GER'},{n:'Wilson',pos:'ATT',ovr:75,nat:'ENG'}],
    'Villarreal': [{n:'Tenas',pos:'POR',ovr:75,nat:'ESP'},{n:'Foyth',pos:'DIF',ovr:79,nat:'ARG'},{n:'Veiga',pos:'DIF',ovr:78,nat:'POR'},{n:'Cardona',pos:'DIF',ovr:74,nat:'ESP'},{n:'Pedraza',pos:'DIF',ovr:74,nat:'ESP'},{n:'Parejo',pos:'CEN',ovr:79,nat:'ESP'},{n:'Partey',pos:'CEN',ovr:78,nat:'GHA'},{n:'Comesana',pos:'CEN',ovr:74,nat:'ESP'},{n:'Pepe',pos:'ATT',ovr:80,nat:'CIV'},{n:'Moreno',pos:'ATT',ovr:79,nat:'ESP'},{n:'Mikautadze',pos:'ATT',ovr:76,nat:'GEO'}],
    'Real Sociedad': [{n:'Remiro',pos:'POR',ovr:80,nat:'ESP'},{n:'Zubeldia',pos:'DIF',ovr:76,nat:'ESP'},{n:'Aramburu',pos:'DIF',ovr:73,nat:'VEN'},{n:'Caleta-Car',pos:'DIF',ovr:75,nat:'CRO'},{n:'Aihen Munoz',pos:'DIF',ovr:73,nat:'ESP'},{n:'Brais Mendez',pos:'CEN',ovr:78,nat:'ESP'},{n:'Zakharyan',pos:'CEN',ovr:77,nat:'RUS'},{n:'Sucic',pos:'CEN',ovr:74,nat:'CRO'},{n:'Oyarzabal',pos:'ATT',ovr:83,nat:'ESP'},{n:'Kubo',pos:'ATT',ovr:81,nat:'JPN'},{n:'Barrenetxea',pos:'ATT',ovr:76,nat:'ESP'}],
    'Eintracht Francoforte': [{n:'Koch',pos:'DIF',ovr:76,nat:'GER'},{n:'Brassier',pos:'DIF',ovr:73,nat:'FRA'},{n:'Fernandes',pos:'DIF',ovr:74,nat:'BRA'},{n:'Chandler',pos:'DIF',ovr:73,nat:'USA'},{n:'Doan',pos:'CEN',ovr:78,nat:'JPN'},{n:'Hojlund',pos:'CEN',ovr:75,nat:'DEN'},{n:'Goetze',pos:'CEN',ovr:77,nat:'GER'},{n:'Chaibi',pos:'CEN',ovr:74,nat:'ALG'},{n:'Uzun',pos:'ATT',ovr:76,nat:'TUR'},{n:'Burkardt',pos:'ATT',ovr:78,nat:'GER'}],
    'Rangers': [{n:'Pandur',pos:'POR',ovr:73,nat:'CRO'},{n:'Souttar',pos:'DIF',ovr:74,nat:'SCO'},{n:'Nedeljkovic',pos:'DIF',ovr:70,nat:'SRB'},{n:'Godfrey',pos:'DIF',ovr:73,nat:'ENG'},{n:'Sterling',pos:'DIF',ovr:70,nat:'ENG'},{n:'Raskin',pos:'CEN',ovr:75,nat:'BEL'},{n:'Neil',pos:'CEN',ovr:72,nat:'ENG'},{n:'McCausland',pos:'CEN',ovr:71,nat:'NIR'},{n:'Chermiti',pos:'ATT',ovr:74,nat:'POR'},{n:'Shankland',pos:'ATT',ovr:75,nat:'SCO'},{n:'Bouanani',pos:'ATT',ovr:71,nat:'ALG'}],
    'Celtic': [{n:'Sinisalo',pos:'POR',ovr:73,nat:'FIN'},{n:'Carter-Vickers',pos:'DIF',ovr:77,nat:'USA'},{n:'Johnston',pos:'DIF',ovr:75,nat:'CAN'},{n:'Scales',pos:'DIF',ovr:73,nat:'IRL'},{n:'Trusty',pos:'DIF',ovr:72,nat:'USA'},{n:'McGregor',pos:'CEN',ovr:77,nat:'SCO'},{n:'McCowan',pos:'CEN',ovr:73,nat:'SCO'},{n:'Oxlade-Chamberlain',pos:'CEN',ovr:75,nat:'ENG'},{n:'Jota',pos:'ATT',ovr:78,nat:'POR'},{n:'Nygren',pos:'ATT',ovr:74,nat:'SWE'},{n:'Yang',pos:'ATT',ovr:71,nat:'KOR'}],
    'Feyenoord': [{n:'Wellenreuther',pos:'POR',ovr:74,nat:'GER'},{n:'Smal',pos:'DIF',ovr:72,nat:'NED'},{n:'Bos',pos:'DIF',ovr:70,nat:'AUS'},{n:'Hwang',pos:'CEN',ovr:75,nat:'KOR'},{n:'Zerrouki',pos:'CEN',ovr:74,nat:'ALG'},{n:'Moussa',pos:'ATT',ovr:73,nat:'ALG'},{n:'Kokcu',pos:'CEN',ovr:76,nat:'TUR'},{n:'Ueda',pos:'ATT',ovr:74,nat:'JPN'},{n:'Bueno',pos:'ATT',ovr:73,nat:'ESP'},{n:'Milambo',pos:'CEN',ovr:73,nat:'NED'}],
    'PSV Eindhoven': [{n:'Kovar',pos:'POR',ovr:75,nat:'CZE'},{n:'Dest',pos:'DIF',ovr:78,nat:'USA'},{n:'Geertruida',pos:'DIF',ovr:79,nat:'NED'},{n:'Flamingo',pos:'DIF',ovr:73,nat:'NED'},{n:'Obispo',pos:'DIF',ovr:72,nat:'CUW'},{n:'Til',pos:'CEN',ovr:75,nat:'NED'},{n:'Schouten',pos:'CEN',ovr:76,nat:'NED'},{n:'Wanner',pos:'CEN',ovr:74,nat:'AUT'},{n:'Perisic',pos:'ATT',ovr:77,nat:'CRO'},{n:'Pepi',pos:'ATT',ovr:75,nat:'USA'},{n:'Man',pos:'ATT',ovr:76,nat:'ROU'}],
    'Olympiacos': [{n:'Ortega',pos:'POR',ovr:75,nat:'GER'},{n:'Saliakas',pos:'DIF',ovr:73,nat:'GRE'},{n:'Pirola',pos:'DIF',ovr:73,nat:'ITA'},{n:'Retsos',pos:'DIF',ovr:74,nat:'GRE'},{n:'Carmo',pos:'DIF',ovr:73,nat:'ANG'},{n:'Cabella',pos:'CEN',ovr:78,nat:'FRA'},{n:'Fortounis',pos:'CEN',ovr:76,nat:'GRE'},{n:'Freuler',pos:'CEN',ovr:78,nat:'SUI'},{n:'Bailey',pos:'ATT',ovr:80,nat:'JAM'},{n:'El Kaabi',pos:'ATT',ovr:77,nat:'MAR'},{n:'Chiquinho',pos:'CEN',ovr:74,nat:'POR'}],
    'Fenerbahce': [{n:'Ederson',pos:'POR',ovr:78,nat:'BRA'},{n:'Skriniar',pos:'DIF',ovr:79,nat:'SVK'},{n:'Semedo',pos:'DIF',ovr:76,nat:'POR'},{n:'Ake',pos:'DIF',ovr:78,nat:'NED'},{n:'Oosterwolde',pos:'DIF',ovr:74,nat:'NED'},{n:'Kante',pos:'CEN',ovr:79,nat:'FRA'},{n:'Guendouzi',pos:'CEN',ovr:78,nat:'FRA'},{n:'Asensio',pos:'CEN',ovr:79,nat:'ESP'},{n:'Irfan Can',pos:'CEN',ovr:75,nat:'TUR'},{n:'Lukaku',pos:'ATT',ovr:82,nat:'BEL'},{n:'Aktuerkoglu',pos:'ATT',ovr:78,nat:'TUR'}],
    'Galatasaray': [{n:'Icardi',pos:'ATT',ovr:81,nat:'ARG'},{n:'Osimhen',pos:'ATT',ovr:83,nat:'NGA'},{n:'Sane',pos:'ATT',ovr:82,nat:'GER'},{n:'Gundogan',pos:'CEN',ovr:80,nat:'GER'},{n:'Torreira',pos:'CEN',ovr:77,nat:'URU'},{n:'Lemina',pos:'CEN',ovr:75,nat:'GAB'},{n:'Sara',pos:'CEN',ovr:74,nat:'BRA'},{n:'Sallai',pos:'ATT',ovr:76,nat:'HUN'},{n:'Singo',pos:'DIF',ovr:76,nat:'CIV'},{n:'Sanchez',pos:'DIF',ovr:75,nat:'COL'},{n:'Muslera',pos:'POR',ovr:70,nat:'URU'}],
    'Besiktas': [{n:'Immobile',pos:'ATT',ovr:79,nat:'ITA'},{n:'Abraham',pos:'ATT',ovr:77,nat:'ENG'},{n:'Rashica',pos:'ATT',ovr:74,nat:'KVX'},{n:'Cerny',pos:'ATT',ovr:73,nat:'CZE'},{n:'Under',pos:'ATT',ovr:74,nat:'TUR'},{n:'Asllani',pos:'CEN',ovr:76,nat:'ALB'},{n:'Ndidi',pos:'CEN',ovr:78,nat:'NGA'},{n:'Uduokhai',pos:'DIF',ovr:73,nat:'GER'},{n:'Djalo',pos:'DIF',ovr:74,nat:'POR'},{n:'Ridvan',pos:'DIF',ovr:72,nat:'TUR'},{n:'Destanoglu',pos:'POR',ovr:73,nat:'TUR'}],
    'Sporting Braga': [{n:'Horta',pos:'ATT',ovr:80,nat:'POR'},{n:'Pau Victor',pos:'ATT',ovr:76,nat:'ESP'},{n:'Gabriel Silva',pos:'ATT',ovr:74,nat:'BRA'},{n:'Moutinho',pos:'CEN',ovr:76,nat:'POR'},{n:'Zalazar',pos:'CEN',ovr:75,nat:'URU'},{n:'Gorby',pos:'CEN',ovr:73,nat:'FRA'},{n:'Huseinbasic',pos:'CEN',ovr:72,nat:'BIH'},{n:'Vitor Carvalho',pos:'DIF',ovr:71,nat:'BRA'},{n:'Barcia',pos:'DIF',ovr:71,nat:'ESP'},{n:'Matheus',pos:'POR',ovr:72,nat:'BRA'}],
    'Slavia Praga': [{n:'Chytil',pos:'ATT',ovr:76,nat:'CZE'},{n:'Schranz',pos:'ATT',ovr:75,nat:'SVK'},{n:'Kusej',pos:'ATT',ovr:73,nat:'CZE'},{n:'Chory',pos:'ATT',ovr:71,nat:'CZE'},{n:'Provod',pos:'CEN',ovr:78,nat:'CZE'},{n:'Sadilek',pos:'CEN',ovr:74,nat:'CZE'},{n:'Dorley',pos:'CEN',ovr:73,nat:'LBR'},{n:'Doudera',pos:'DIF',ovr:73,nat:'CZE'},{n:'Zima',pos:'DIF',ovr:74,nat:'CZE'},{n:'Holes',pos:'DIF',ovr:71,nat:'CZE'},{n:'Stanek',pos:'POR',ovr:72,nat:'CZE'}],
    'Dinamo Zagabria': [{n:'Vidovic',pos:'ATT',ovr:75,nat:'CRO'},{n:'Mudrazija',pos:'CEN',ovr:72,nat:'CRO'},{n:'Misic',pos:'CEN',ovr:74,nat:'CRO'},{n:'Zajc',pos:'CEN',ovr:76,nat:'SVN'},{n:'Stojkovic',pos:'CEN',ovr:71,nat:'CRO'},{n:'McKenna',pos:'DIF',ovr:75,nat:'SCO'},{n:'Torrente',pos:'DIF',ovr:70,nat:'ESP'},{n:'Goda',pos:'DIF',ovr:69,nat:'CRO'},{n:'Valincic',pos:'DIF',ovr:68,nat:'CRO'},{n:'Nevistic',pos:'POR',ovr:71,nat:'CRO'}],
    'Shakhtar Donetsk': [{n:'Sudakov',pos:'CEN',ovr:82,nat:'UKR'},{n:'Traore',pos:'ATT',ovr:77,nat:'BFA'},{n:'Kaua Elias',pos:'ATT',ovr:74,nat:'BRA'},{n:'Pedrinho',pos:'CEN',ovr:75,nat:'BRA'},{n:'Marlon Gomes',pos:'CEN',ovr:74,nat:'BRA'},{n:'Isaque',pos:'CEN',ovr:73,nat:'BRA'},{n:'Bondar',pos:'DIF',ovr:76,nat:'UKR'},{n:'Matviyenko',pos:'DIF',ovr:75,nat:'UKR'},{n:'Vinicius Tobias',pos:'DIF',ovr:73,nat:'BRA'},{n:'Karavaiev',pos:'DIF',ovr:72,nat:'UKR'},{n:'Riznyk',pos:'POR',ovr:70,nat:'UKR'}],
    'Club Brugge': [{n:'Vanaken',pos:'CEN',ovr:82,nat:'BEL'},{n:'Tzolis',pos:'ATT',ovr:79,nat:'GRE'},{n:'Nielsen',pos:'ATT',ovr:76,nat:'SWE'},{n:'Jashari',pos:'CEN',ovr:78,nat:'SUI'},{n:'Onyedika',pos:'CEN',ovr:74,nat:'NGA'},{n:'Sabbe',pos:'DIF',ovr:73,nat:'BEL'},{n:'Mechele',pos:'DIF',ovr:73,nat:'BEL'},{n:'Spileers',pos:'DIF',ovr:72,nat:'BEL'},{n:'Meijer',pos:'DIF',ovr:71,nat:'NED'},{n:'Mignolet',pos:'POR',ovr:76,nat:'BEL'}],
    'Anderlecht': [{n:'Hazard',pos:'ATT',ovr:78,nat:'BEL'},{n:'Verschaeren',pos:'CEN',ovr:77,nat:'BEL'},{n:'Stroeykens',pos:'CEN',ovr:75,nat:'BEL'},{n:'Sikan',pos:'ATT',ovr:73,nat:'UKR'},{n:'Huerta',pos:'ATT',ovr:72,nat:'MEX'},{n:'Rits',pos:'CEN',ovr:73,nat:'BEL'},{n:'Foket',pos:'DIF',ovr:72,nat:'BEL'},{n:'Sardella',pos:'DIF',ovr:71,nat:'BEL'},{n:'Kana',pos:'DIF',ovr:70,nat:'BEL'},{n:'Coosemans',pos:'POR',ovr:74,nat:'BEL'}],
    'Young Boys': [{n:'Fassnacht',pos:'ATT',ovr:76,nat:'SUI'},{n:'Sanches',pos:'CEN',ovr:75,nat:'POR'},{n:'Bedia',pos:'ATT',ovr:74,nat:'CIV'},{n:'Hadjam',pos:'DIF',ovr:73,nat:'ALG'},{n:'Ganvoula',pos:'ATT',ovr:72,nat:'CGO'},{n:'Elia',pos:'ATT',ovr:71,nat:'COD'},{n:'Rieder',pos:'CEN',ovr:72,nat:'SUI'},{n:'Lauper',pos:'CEN',ovr:70,nat:'SUI'},{n:'Camara',pos:'DIF',ovr:69,nat:'GUI'},{n:'Kayondo',pos:'POR',ovr:68,nat:'UGA'}],
    'Salisburgo': [{n:'Ratkov',pos:'ATT',ovr:76,nat:'SRB'},{n:'Kjaergaard',pos:'CEN',ovr:75,nat:'DEN'},{n:'Vertessen',pos:'ATT',ovr:73,nat:'BEL'},{n:'Alajbegovic',pos:'ATT',ovr:74,nat:'BIH'},{n:'Bidstrup',pos:'CEN',ovr:73,nat:'DEN'},{n:'Diabate',pos:'DIF',ovr:71,nat:'MLI'},{n:'Lainer',pos:'DIF',ovr:73,nat:'AUT'},{n:'Rasmussen',pos:'DIF',ovr:72,nat:'DEN'},{n:'Baidoo',pos:'DIF',ovr:70,nat:'AUT'},{n:'Schlager',pos:'POR',ovr:74,nat:'AUT'}],
