...
/* ============================================================
 ...
 ,
  ...
  const EURO_ROSTERS = {
    ...
    'Chelsea': [{n:'E. Martinez',pos:'POR',ovr:84,nat:'ARG',age:34},{n:'James',pos:'DIF',ovr:82,nat:'ENG',age:26},{n:'Colwill',pos:'DIF',ovr:83,nat:'ENG',age:23},{n:'Fofana',pos:'DIF',ovr:81,nat:'FRA',age:26},{n:'Gusto',pos:'DIF',ovr:80,nat:'FRA',age:23},{n:'Caicedo',pos:'CEN',ovr:85,nat:'ECU',age:24},{n:'Palmer',pos:'CEN',ovr:87,nat:'ENG',age:24},{n:'Barco',pos:'CEN',ovr:78,nat:'ARG'},{n:'Joao Pedro',pos:'ATT',ovr:83,nat:'BRA',age:24},{n:'Estevao',pos:'ATT',ovr:83,nat:'BRA',age:19},{n:'Neto',pos:'ATT',ovr:81,nat:'POR',age:26},{n:'Gittens',pos:'ATT',ovr:78,nat:'ENG',age:22}],
    ...
    'Benfica': [{n:'Trubin',pos:'POR',ovr:82,nat:'UKR',age:24},{n:'Antonio Silva',pos:'DIF',ovr:83,nat:'POR',age:22},{n:'Otamendi',pos:'DIF',ovr:78,nat:'ARG',age:38},{n:'Bah',pos:'DIF',ovr:77,nat:'DEN',age:29},{n:'Kokcu',pos:'CEN',ovr:80,nat:'TUR'},{n:'Florentino',pos:'CEN',ovr:76,nat:'POR',age:27},{n:'Barrenechea',pos:'CEN',ovr:77,nat:'ARG',age:25},{n:'Richard Rios',pos:'CEN',ovr:79,nat:'COL',age:26},{n:'Akturkoglu',pos:'ATT',ovr:78,nat:'TUR',age:27},{n:'Pavlidis',pos:'ATT',ovr:81,nat:'GRE',age:28},{n:'Aursnes',pos:'CEN',ovr:75,nat:'NOR'}],
    'Porto': [{n:'Diogo Costa',pos:'POR',ovr:85,nat:'POR',age:27},{n:'Nehuen Perez',pos:'DIF',ovr:78,nat:'ARG',age:27},{n:'Zaidu',pos:'DIF',ovr:75,nat:'NGA'},{n:'Bednarek',pos:'DIF',ovr:76,nat:'POL',age:30},{n:'Eustaquio',pos:'CEN',ovr:78,nat:'CAN',age:28},{n:'Alan Varela',pos:'CEN',ovr:80,nat:'ARG',age:26},{n:'Gabri Veiga',pos:'CEN',ovr:79,nat:'ESP',age:24},{n:'Rodrigo Mora',pos:'CEN',ovr:78,nat:'POR',age:19},{n:'Pepe',pos:'ATT',ovr:77,nat:'BRA',age:30},{n:'Samu',pos:'ATT',ovr:78,nat:'ESP',age:24},{n:'Luuk de Jong',pos:'ATT',ovr:76,nat:'NED',age:36},{n:'Borja Sainz',pos:'ATT',ovr:77,nat:'ESP'}],
    ...
    'Sporting Lisbona': [{n:'Israel',pos:'POR',ovr:78,nat:'URU',age:26},{n:'Debast',pos:'DIF',ovr:78,nat:'BEL',age:22},{n:'St. Juste',pos:'DIF',ovr:77,nat:'NED',age:29},{n:'Quaresma',pos:'DIF',ovr:75,nat:'POR'},{n:'Morita',pos:'CEN',ovr:76,nat:'JPN',age:31},{n:'Zalazar',pos:'CEN',ovr:76,nat:'URU',age:26},{n:'Pote',pos:'CEN',ovr:80,nat:'POR',age:27},{n:'Trincao',pos:'ATT',ovr:80,nat:'POR',age:26},{n:'Geny Catamo',pos:'ATT',ovr:77,nat:'MOZ',age:25},{n:'Luis Suarez',pos:'ATT',ovr:79,nat:'COL',age:21},{n:'Fotis Ioannidis',pos:'ATT',ovr:77,nat:'GRE',age:28}],
    ...
    'Rangers': [{n:'Pandur',pos:'POR',ovr:73,nat:'CRO'},{n:'Souttar',pos:'DIF',ovr:74,nat:'SCO',age:28},{n:'Nedeljkovic',pos:'DIF',ovr:70,nat:'SRB'},{n:'Godfrey',pos:'DIF',ovr:73,nat:'ENG',age:28},{n:'Sterling',pos:'DIF',ovr:70,nat:'ENG'},{n:'Raskin',pos:'CEN',ovr:75,nat:'BEL'},{n:'Neil',pos:'CEN',ovr:72,nat:'ENG'},{n:'McCausland',pos:'CEN',ovr:71,nat:'NIR'},{n:'Chermiti',pos:'ATT',ovr:74,nat:'POR'},{n:'Shankland',pos:'ATT',ovr:75,nat:'SCO',age:31},{n:'Bouanani',pos:'ATT',ovr:71,nat:'ALG'}],
    'Celtic': [{n:'Sinisalo',pos:'POR',ovr:73,nat:'FIN'},{n:'Carter-Vickers',pos:'DIF',ovr:77,nat:'USA',age:29},{n:'Johnston',pos:'DIF',ovr:75,nat:'CAN'},{n:'Scales',pos:'DIF',ovr:73,nat:'IRL'},{n:'Trusty',pos:'DIF',ovr:72,nat:'USA'},{n:'McGregor',pos:'CEN',ovr:77,nat:'SCO',age:34},{n:'McCowan',pos:'CEN',ovr:73,nat:'SCO'},{n:'Oxlade-Chamberlain',pos:'CEN',ovr:75,nat:'ENG'},{n:'Jota',pos:'ATT',ovr:78,nat:'POR',age:27},{n:'Nygren',pos:'ATT',ovr:74,nat:'SWE'},{n:'Yang',pos:'ATT',ovr:71,nat:'KOR'}],
